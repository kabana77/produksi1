object HasilPengeringFrm: THasilPengeringFrm
  Left = 261
  Top = 77
  Width = 1011
  Height = 659
  Caption = 'Hasil Pengeringan'
  Color = clBtnFace
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db3.vhasilpengeringfrm')
  ...
  object QLookItem: TOracleDataSet
    SQL.Strings = (
      'SELECT'
        ...
        'A.kd_item21, A.kd_item, A.nama_item, A.kd_sub_lokasi, A.satuan, ' +
        'A.rasio, A.kd_satuan, A.kd_warna, A.warna, A.no_batch,'
      ...
      '    (    '
      '    select '
      '    a.kd_item as kd_item21,'
      
        '    '#39'22.'#39'||substr(a.kd_item,4,10) as kd_item, ---awalnya item 21' +
        '.'
      '    a.kd_jns_item,'
      '    a.nama_item,'
      '    a.kd_satuan,'
      '    '#39'22-10000'#39' as kd_sub_lokasi,'#9
      '    a.satuan,'
      '    a.rasio,'
      '    a.kd_sub_kel as kd_sub_kel,'
      '    c.kd_warna as kd_warna,'
      '    c.warna as warna,'
      '    b.no_batch as no_batch,'
      ''
      '----------------AWAL PEMASUKAN'
      ...
      '      trunc(tgl)<=trunc(:psysdate) and '
        ...
        '      kd_transaksi='#39'795'#39' and kd_lokasi=:vjns_brg and jns_lokasi=' +
        #39'PROSES'#39' and '
      
        '      kd_item=a.kd_item and kd_warna=b.kd_warna and no_batch=b.n' +
        'o_batch '
      '      )/1 '
      '      AS awmasuk1,'
      ...
      '      trunc(tgl)<=trunc(:psysdate) and '
        ...
        '      jns_koreksi='#39'KOREKSI3'#39' and kd_lokasi=:vjns_brg and kd_tran' +
        'saksi='#39'807'#39'  and qty_in>0 and '
      ...
      '      trunc(tgl)<=trunc(:psysdate) and '
        ...
        '      jns_koreksi='#39'KOREKSI3'#39' and kd_lokasi=:vjns_brg and kd_tran' +
        'saksi='#39'807'#39'  and qty_in2>0 and '
      ...
      '      trunc(tgl)<=trunc(:psysdate) and '
        ...
        '      kd_lokasi=:vjns_brg and kd_transaksi='#39'793'#39' and jns_lokasi=' +
        #39'PROSES'#39' and '
      ...
      '      trunc(tgl)<=trunc(:psysdate) and '
        ...
        '      kd_transaksi='#39'793'#39' and kd_lokasi=:vjns_brg and jns_lokasi=' +
        #39'PROSES'#39' and '
      ...
      '      trunc(tgl)<=trunc(:psysdate) and '
        ...
        '      kd_transaksi='#39'807'#39' and kd_lokasi=:vjns_brg and jns_koreksi' +
        '='#39'KOREKSI3'#39' and qty_in<0 and '
      ...
      '      trunc(tgl)<=trunc(:psysdate) and '
        ...
        '      kd_transaksi='#39'807'#39' and kd_lokasi=:vjns_brg and jns_koreksi' +
        '='#39'KOREKSI3'#39' and qty_in2<0 and '
      ...
      ''
        ...
        '    from ipisma_db3.vitemall a, ipisma_db3.vitem_warna_batch b, ' +
        'ipisma_db3.vi_warna_baru_2017 c    '
      '    where '
      '    a.nama_item=:vnama_item and'
      '    a.kd_jns_item=:vjns_item and '
      '    a.kd_sub_kel=:vkd_benang and'
      '    b.kd_jns_item=:vjns_item and '
      '    a.kd_item=b.kd_item and '
      '    b.kd_warna=c.kd_warna and '
      
        '    ((C.KD_WARNA like '#39'%'#39'||:pfilter||'#39'%'#39') OR (C.WARNA like '#39'%'#39'||' +
        ':pfilter||'#39'%'#39') OR (B.NO_BATCH like '#39'%'#39'||:pfilter||'#39'%'#39'))'
      
        '--    ((C.WARNA like '#39'%'#39'||:pfilter||'#39'%'#39') OR (B.NO_BATCH like '#39'%'#39 +
        '||:pfilter||'#39'%'#39'))'
      
        '---(a.kd_item like '#39'%'#39'||:pfilter||'#39'%'#39') OR (a.nama_item like '#39'%'#39'|' +
        '|:pfilter||'#39'%'#39') OR'
      '  )'
      '   WHERE (awmasuk2+awmasuk4) - (awkeluar2+awkoreksi2) <> 0'
      ') A,'
      '(select '
      'KD_ITEM, KD_WARNA, NO_BATCH,'
      'NVL(sum(QTY1),0) as qty1, '
      'NVL(sum(QTY2),0) as qty2'
      'from ipisma_db3.bukti_detail a'
      'where ibukti = :ibukti'
      'group by ibukti, kd_item, kd_warna, no_batch) B'
      
        'WHERE A.KD_ITEM=B.KD_ITEM(+) AND A.KD_WARNA=B.KD_WARNA(+) AND A.' +
        'NO_BATCH=B.NO_BATCH(+)')
    Variables.Data = {
      0300000007000000090000003A564A4E535F4252470500000005000000273232
      ...
      4D05000000050000002732312700000000000B0000003A564E414D415F495445
      4D050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      ...
      000000090000004B445F4954454D3231010000000000}
    Cursor = crSQLWait
    ReadOnly = True
    QueryAllRecords = False
    BeforeQuery = QLookItemBeforeQuery
    Session = DMFrm.OS
    Left = 464
    Top = 352
    object QLookItemWARNA: TStringField
      DisplayWidth = 30
      FieldName = 'WARNA'
      Size = 50
    end
    object QLookItemKD_WARNA: TStringField
      DisplayLabel = 'KODE'
      DisplayWidth = 6
      FieldName = 'KD_WARNA'
      Size = 6
    end
    object QLookItemNO_BATCH: TStringField
      DisplayLabel = 'NO BATCH'
      DisplayWidth = 12
      FieldName = 'NO_BATCH'
      Size = 50
    end
    object QLookItemQTY2: TFloatField
      DisplayLabel = 'Qty (Pcs)'
      DisplayWidth = 10
      FieldName = 'QTY2'
    end
    object QLookItemQTY: TFloatField
      DisplayLabel = 'Qty (Kg)'
      DisplayWidth = 10
      FieldName = 'QTY'
    end
    ...
    object QLookItemKD_ITEM21: TStringField
      FieldName = 'KD_ITEM21'
      Required = True
      Visible = False
      Size = 50
  ...
  object QItem: TOracleDataSet
    SQL.Strings = (
      ...
      'where kd_jns_item=:vjns_brg and kd_sub_kel=:vkd_benang  '
        ...
        #9'and ((kd_item like '#39'%'#39'||:pfilter||'#39'%'#39') OR (nama_item like '#39'%'#39'||' +
        ':pfilter||'#39'%'#39'))'
      'order by nama_item')
    Variables.Data = {
      0300000003000000090000003A564A4E535F4252470500000003000000323200
      000000000B0000003A564B445F42454E414E47050000000800000035352F5320
      54520000000000080000003A5046494C544552050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      040000000C000000070000004B445F4954454D010000000000090000004E414D
  ...
  object QLookItemBaru: TOracleDataSet
    SQL.Strings = (
      '/*select * from ipisma_db3.VLOOK_WARNA_HP_PENGERING'
      'where kd_item = :vkd_benang and qty <> 0*/'
      ''
      'select * from ('
      
        'select a.item, sum(a.kg) as qty, sum(a.pcs) as qty2, b.kd_item, ' +
        'b.nama_item, c.kd_warna, c.warna, substr(a.item, 11) as no_batch'
      'from'
      '('
      '  -- ST Celup'
      '  select'
      
        '     (substr(kd_item, 4, 5)||'#39'.'#39'||kd_warna||'#39'.'#39'||no_batch) as it' +
        'em, qty_in as kg, qty_in2 as pcs'
      '  from ipisma_db3.GD_STOK'
      
        '  where kd_transaksi = '#39'795'#39' AND kd_sub_lokasi = '#39'22-10000'#39' and ' +
        'kd_sub_lokasi2 = '#39'21-00000'#39
      ''
      '  -- HP PENGERING'
      '  union all'
      ''
      ...
      '  from ipisma_db3.GD_STOK'
        ...
        '  where kd_transaksi = '#39'793'#39' and kd_sub_lokasi = '#39'22-00000'#39' and ' +
        'kd_sub_lokasi2 is null'
      ''
      '  -- CURRENT ENTRY'
      '  union all'
      ''
      '  select'
        ...
        '     (substr(b.kd_item, 4, 5)||'#39'.'#39'||b.kd_warna||'#39'.'#39'||b.no_batch)' +
        ' as item, -b.qty1 as kg, -b.qty2 as pcs'
      '  from ipisma_db3.bukti a, ipisma_db3.bukti_detail b'
      
        '  where a.kd_transaksi = '#39'793'#39' and a.ibukti=b.ibukti and b.ibukt' +
        'i = :vibukti'
      ''
      ') a'
      
        'left join ipisma_db3.item b on substr(b.kd_item, 4, 5)= substr(a' +
        '.item, 1, 5) and b.kd_jns_item = '#39'22'#39
      
        'left join ipisma_db3.warna_baru c on c.kd_warna= substr(a.item, ' +
        '7, 3)'
      'group by a.item, b.kd_item, b.nama_item, c.kd_warna, c.warna'
      ') where kd_item = :vkd_benang and qty <> 0')
    Variables.Data = {
      03000000020000000B0000003A564B445F42454E414E47050000000900000032
      322E31343633390000000000080000003A564942554B54490300000000000000
      00000000}
    QBEDefinition.QBEFieldDefs = {
      
      454D010000000000}
    Cursor = crSQLWait
    ReadOnly = True
    QueryAllRecords = False
    BeforeQuery = QLookItemBaruBeforeQuery
    Session = DMFrm.OS
    Left = 472
    Top = 400
    object QLookItemBaruITEM: TStringField
      FieldName = 'ITEM'
      Size = 63
    end
    object QLookItemBaruQTY: TFloatField
      FieldName = 'QTY'
    end
    object QLookItemBaruQTY2: TFloatField
      FieldName = 'QTY2'
    end
    object QLookItemBaruKD_ITEM: TStringField
      FieldName = 'KD_ITEM'
      Required = True
      Size = 50
    end
    object QLookItemBaruNAMA_ITEM: TStringField
      FieldName = 'NAMA_ITEM'
      Required = True
      Size = 50
    end
    object QLookItemBaruKD_WARNA: TStringField
      FieldName = 'KD_WARNA'
      Size = 6
    end
    object QLookItemBaruWARNA: TStringField
      FieldName = 'WARNA'
      Size = 50
    end
    object QLookItemBaruNO_BATCH: TStringField
      FieldName = 'NO_BATCH'
      Size = 53
    end
  end
