...
var
  PindahLokasi3Frm: TPindahLokasi3Frm;
...
//  if BPBFrm=Nil then
  begin
    PindahLokasi3Frm:=TPindahLokasi3Frm.Create(Application);
    PindahLokasi3Frm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       PindahLokasi3Frm.QMaster.ReadOnly:=True;
       PindahLokasi3Frm.QDetail.ReadOnly:=True;
    end;

    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    PindahLokasi3Frm.Caption:=UpperCase(pjudul);
    PindahLokasi3Frm.vkode:=pkode;
    PindahLokasi3Frm.vjns_lokasi:=pjns_lokasi;
    PindahLokasi3Frm.vjns_brg:=pjns_brg;
    PindahLokasi3Frm.QTransaksi.Open;

    PindahLokasi3Frm.PanelHeader.Caption:=PindahLokasi3Frm.QTransaksiKD_TRANSAKSI.AsString+'. '+PindahLokasi3Frm.QTransaksiNAMA_TRANSAKSI.AsString;
    PindahLokasi3Frm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    PindahLokasi3Frm.wwDBGrid1.IniAttributes.SectionName:=PindahLokasi3Frm.Caption+'1';
    PindahLokasi3Frm.wwDBGrid1.IniAttributes.Enabled:=True;
    PindahLokasi3Frm.wwDBGrid1.LoadFromIniFile;
    PindahLokasi3Frm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    PindahLokasi3Frm.wwDBGrid2.IniAttributes.SectionName:=PindahLokasi3Frm.Caption+'2';
    PindahLokasi3Frm.wwDBGrid2.IniAttributes.Enabled:=True;
    PindahLokasi3Frm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,PindahLokasi3Frm.Caption+'1',PindahLokasi3Frm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,PindahLokasi3Frm.Caption+'2',PindahLokasi3Frm.wwDBGrid2);
    PindahLokasi3Frm.wwDBSpinLine1.Value:=PindahLokasi3Frm.wwDBGrid1.RowHeightPercent;
    PindahLokasi3Frm.wwDBSpinLine2.Value:=PindahLokasi3Frm.wwDBGrid2.RowHeightPercent;

  end;

  PindahLokasi3Frm.Show;
end;

procedure TPindahLokasi3Frm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'1',wwDBGrid1);
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   PindahLokasi3Frm:=Nil;
end;

procedure TPindahLokasi3Frm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TPindahLokasi3Frm.BtnExportClick(Sender: TObject);
begin
...
procedure TPindahLokasi3Frm.BtnOkClick(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vjam : string;
  ...
  if vTglAwal.Date>vTglAkhir.DateTime then
    ...
    begin
      ...
      QBrowse.DeclareVariable('porder',otSubst);
        ...
        begin
          QBrowse.Close;
          QBrowse.SQL.Text:='select * from '+cUserTabel+'vPindahLokasi217 where tanggal>=:pawal and tanggal<=:pakhir and kd_transaksi=:kd_transaksi :porder';
...
procedure TPindahLokasi3Frm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TPindahLokasi3Frm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TPindahLokasi3Frm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TPindahLokasi3Frm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TPindahLokasi3Frm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TPindahLokasi3Frm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TPindahLokasi3Frm.BtnFindClick(Sender: TObject);
begin
...
procedure TPindahLokasi3Frm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TPindahLokasi3Frm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=0;
end;

procedure TPindahLokasi3Frm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TPindahLokasi3Frm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TPindahLokasi3Frm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TPindahLokasi3Frm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TPindahLokasi3Frm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TPindahLokasi3Frm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
{  if key=13 then
  begin
...
procedure TPindahLokasi3Frm.TabSheet1Show(Sender: TObject);
begin
...
procedure TPindahLokasi3Frm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TPindahLokasi3Frm.ppDetailBand2BeforePrint(Sender: TObject);
begin
  ppNo2.AsInteger:=ppNo2.AsInteger+1;
end;

procedure TPindahLokasi3Frm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure TPindahLokasi3Frm.BtnPrintInputClick(Sender: TObject);
begin
  ppDBQMaster.Close;
  ppDBQMaster.Open;
  ppDBQDetail.Close;
...
procedure TPindahLokasi3Frm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TPindahLokasi3Frm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TPindahLokasi3Frm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TPindahLokasi3Frm.Label5Click(Sender: TObject);
begin
...
procedure TPindahLokasi3Frm.LookItemEnter(Sender: TObject);
var
tgl_awal : tdatetime;
begin
 if wwDBDateTimePicker1.Date >= StrToDate('01/01/2017') then
  begin
    ...
    //ShowMessage('vjns_lokasi=21');
      ...
      ' a.kd_jns_item=:vjns_brg and c.kd_lokasi=:vjns_lokasi '+
      ' and b.tgl >= to_date(''01/01/2018'',''dd/mm/yyyy'') and b.tgl<=:tgl and a.kd_item <>''21.14581'' '+
      ...
      ' having sum(b.qty_in2-b.qty_out2)>0'+
      ' ORDER BY a.nama_item, e.warna';   //190523
    ...
    QItem.SQL.Text:=
    ' select v.kd_item, v.nama_item, v.kd_satuan, v.rasio, v.satuan, v.min_stok, v.kd_jns_item, v.kd_sub_lokasi, v.kd_warna, v.warna, v.no_batch,'+
    ' (NVL(v.qty,0)-NVL(w.QTY1,0)) as qty, (NVL(v.qty2,0)-NVL(w.QTY2,0)) as qty2'+
    ' from'+
    ' (select kd_item, nama_item, kd_satuan, rasio, satuan, min_stok, kd_jns_item, kd_sub_lokasi, kd_warna, warna, no_batch,'+
    ' qty, qty2'+
    ' from'+
      ' (select a.kd_item, a.nama_item, a.kd_satuan, a.rasio, d.satuan, a.min_stok, a.kd_jns_item, b.kd_sub_lokasi, b.kd_warna, e.warna, b.no_batch,'+
      ' sum(b.qty_in-b.qty_out) as qty, sum(b.qty_in2-b.qty_out2) as qty2'+
      ' from '+cUserTabel+'item a, '+cUserTabel+'gd_stok b, '+cUserTabel+'sub_lokasi c, '+cUserTabel+'satuan d, '+cUserTabel+'vi_warna_baru_2017 e'+
      ' where a.kd_item=b.kd_item and b.kd_sub_lokasi=c.kd_sub_lokasi and b.kd_warna=e.kd_warna and'+
      ' a.kd_satuan=d.kd_satuan and c.jns_lokasi=''LOKASI'' and'+
    ...
    ' (select KD_ITEM, KD_WARNA, NO_BATCH, NVL(sum(QTY2),0) as qty1, NVL(sum(QTY7),0) as qty2'+
...
procedure TPindahLokasi3Frm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TPindahLokasi3Frm.QMasterNewRecord(DataSet: TDataSet);
begin
  ...
  QMasterJENIS.AsString:='-'; //230524
  wwDBDateTimePicker1.Enabled:=True;
  lookjns.Enabled:=True;  //020324
...
procedure TPindahLokasi3Frm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TPindahLokasi3Frm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TPindahLokasi3Frm.FormCloseQuery(Sender: TObject;
...
procedure TPindahLokasi3Frm.QMasterAfterPost(DataSet: TDataSet);
begin
  PageControl1.Pages[1].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
  PageControl1.Pages[2].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
end;

procedure TPindahLokasi3Frm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TPindahLokasi3Frm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TPindahLokasi3Frm.QLokasiBeforeOpen(DataSet: TDataSet);
var
...
procedure TPindahLokasi3Frm.LookLokasiEnter(Sender: TObject);
begin
  QLokasi.Close;
  QLokasi.Open;
end;

procedure TPindahLokasi3Frm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
{    QItem.DeclareVariable('vjns_brg',otString);
    QItem.DeclareVariable('vjns_lokasi',otString);
    QItem.DeclareVariable('TGL',otDate);
...
procedure TPindahLokasi3Frm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TPindahLokasi3Frm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TPindahLokasi3Frm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TPindahLokasi3Frm.TabSheet3Show(Sender: TObject);
begin
...
procedure TPindahLokasi3Frm.LookWarnaEnter(Sender: TObject);
begin
  DMFrm.QWarna.Open;
end;

procedure TPindahLokasi3Frm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TPindahLokasi3Frm.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  DMFrm.QDateTime.Open;
end;

procedure TPindahLokasi3Frm.QRBand6BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  DMFrm.QDateTime.Open;
end;

procedure TPindahLokasi3Frm.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLPeriode1.Caption:=vTglAwal.Text+' s/d '+vTglAkhir.Text;
end;

procedure TPindahLokasi3Frm.wwDBDateTimePicker1Change(Sender: TObject);
begin
  QItem.Refresh;
end;

procedure TPindahLokasi3Frm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TPindahLokasi3Frm.QMasterAfterDelete(DataSet: TDataSet);
begin
  wwDBDateTimePicker1.Enabled:=False;
