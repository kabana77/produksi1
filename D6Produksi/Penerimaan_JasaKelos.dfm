object Penerimaan_JasaKelosFrm: TPenerimaan_JasaKelosFrm
  Left = 310
  Top = 116
  Width = 1057
  Height = 600
  Caption = 'PENERIMAAN JASA KELOS'
  Color = clBtnFace
  ...
  object QHasilNota: TOracleDataSet
    SQL.Strings = (
      'select '
      'x.kd_item30, '
      'x.keterangan30,'
      ...
      'x.kg/v.rasio as pcs,'
        ...
        'v.kd_item_benang, v.nama_item as nama_item_benang, v.rasio, '#39'-'#39' ' +
        'as no_batch, '#39#39' as kd_satuan'
      'from'
      '('
      'select '
      'd.kd_konstruksi as kd_item30, '
      'k.keterangan as keterangan30,'
      'd.kd_warna, '
      'd.kg--, '
      '--d.pcs'
      'from ipisma_db4.kelos k, ipisma_db4.kelos_detail d'
      'where kd_transaksi = '#39'861'#39' and ispost='#39'1'#39' and k.no_reg=d.no_reg'
      'and k.keterangan = '#39'GUDANG WARNA'#39
      'and k.no_nota=:no_nota'
      ') x, ipisma_db3.vkonversi_item_benang30 v'
      'where x.kd_item30=v.kd_item(+)'
      ''
      '')
    Variables.Data = {
      0300000001000000080000003A4E4F5F4E4F5441050000000F0000003836312D
      313930342D30303730370000000000}
    QBEDefinition.QBEFieldDefs = {
    ...
    Cursor = crSQLWait
    Session = DMFrm.OS
    BeforeOpen = QHasilNotaBeforeOpen
    Left = 248
    Top = 240
    object QHasilNotaKD_ITEM30: TStringField
      FieldName = 'KD_ITEM30'
      Size = 13
    end
    object QHasilNotaKETERANGAN30: TStringField
      FieldName = 'KETERANGAN30'
      Size = 255
    end
    object QHasilNotaRASIO: TFloatField
      FieldName = 'RASIO'
    end
    object QHasilNotaKD_SATUAN: TStringField
      FieldName = 'KD_SATUAN'
      Size = 2
    end
    object QHasilNotaNO_BATCH: TStringField
      FieldName = 'NO_BATCH'
      Size = 50
    end
    object QHasilNotaKD_WARNA: TStringField
      FieldName = 'KD_WARNA'
      Size = 6
    end
    object QHasilNotaKG: TFloatField
      FieldName = 'KG'
    end
    object QHasilNotaPCS: TFloatField
      FieldName = 'PCS'
    end
    object QHasilNotaKD_ITEM_BENANG: TStringField
      FieldName = 'KD_ITEM_BENANG'
    end
    object QHasilNotaNAMA_ITEM_BENANG: TStringField
  ...
  object QCekNota: TOracleDataSet
    SQL.Strings = (
      'select count(b.no_bukti) as NoNota'
    ...
    Left = 184
    Top = 152
    object QCekNotaNoNota: TFloatField
      FieldName = 'NoNota'
    end
  end
