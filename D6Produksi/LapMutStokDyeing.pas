...
type
  TLapMutStokDyeingFrm = class(TForm)
    PanelMain: TPanel;
    PanelHeader: TPanel;
    PanelFilter: TPanel;
    LabelBanner: TLabel;
...
var
  LapMutStokDyeingFrm: TLapMutStokDyeingFrm;
...
//  if InfoWIPPengeringanFrm=Nil then
  begin
    LapMutStokDyeingFrm:=TLapMutStokDyeingFrm.Create(Application);
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    LapMutStokDyeingFrm.vkode:=pbrg;
    LapMutStokDyeingFrm.QTransaksi.Open;


    LapMutStokDyeingFrm.PanelHeader.Caption:=pjudul;
    LapMutStokDyeingFrm.Caption:=UpperCase(LapMutStokDyeingFrm.PanelHeader.Caption);
  ...
  LapMutStokDyeingFrm.Show;
end;

procedure TLapMutStokDyeingFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid1);
   Action:=caFree;
   LapMutStokDyeingFrm:=Nil;
   QuickRep1:=Nil;
end;

procedure TLapMutStokDyeingFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TLapMutStokDyeingFrm.BtnExportClick(Sender: TObject);
begin
...
//     DMFrm.SaveDialog1.FileName:=PanelHeader.Caption+' '+ vTglAwal.Text+' sd '+vTglAkhir.Text+'.xlk';
     DMFrm.SaveDialog1.FileName:='Laporan Mutasi Stok Softcone '+ vTglAwal.Text+' sd '+vTglAkhir.Text+'.xlk';
     wwDBGrid1.ExportOptions.TitleName:='<font size=4>'+'LAPORAN MUTASI STOK SOFTCONE DEPT DYEING'+'</font><br><font size=3>'+vTglAwal.Text+' s.d '+vTglAkhir.Text+'</font><br><font size=0>'+'.';
...
procedure TLapMutStokDyeingFrm.BtnOkClick(Sender: TObject);
var
...
//  Showmessage('Proses Laporan Mutasi Stok Softcone selesai..!!');
  end
...
procedure TLapMutStokDyeingFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TLapMutStokDyeingFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TLapMutStokDyeingFrm.wwDBSpinLine2Change(Sender: TObject);
begin
//    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TLapMutStokDyeingFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TLapMutStokDyeingFrm.BtnOk2Click(Sender: TObject);
begin
...
procedure TLapMutStokDyeingFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  QuickRep1.Preview;
end;

procedure TLapMutStokDyeingFrm.BtnPrintBrowse1Click(Sender: TObject);
var checbox : byte;
begin

end;

procedure TLapMutStokDyeingFrm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TLapMutStokDyeingFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TLapMutStokDyeingFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TLapMutStokDyeingFrm.Label5Click(Sender: TObject);
begin
...
procedure TLapMutStokDyeingFrm.LookItemEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TLapMutStokDyeingFrm.ppDetailBand1BeforePrint(Sender: TObject);
begin
 ppLblNomer.Caption:=IntToStr(ppDBQBrowseDetail.RecordNo+1)
end;

procedure TLapMutStokDyeingFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TLapMutStokDyeingFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TLapMutStokDyeingFrm.FormShow(Sender: TObject);
begin
...
procedure TLapMutStokDyeingFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
    LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TLapMutStokDyeingFrm.BitBtnPrint2Click(Sender: TObject);
begin
  QuickRep2.Preview;
end;

procedure TLapMutStokDyeingFrm.cbAdaTransaksiClick(Sender: TObject);
begin
if PageControl1.ActivePage.TabIndex=0 then
//SOFTCONE
...
procedure TLapMutStokDyeingFrm.TitleBand1BeforePrint(
...
procedure TLapMutStokDyeingFrm.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLapMutStokDyeingFrm.QRBand6BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  DMFrm.QDateTime.Open;
end;

procedure TLapMutStokDyeingFrm.QRBand8BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
//  QRLabel55.Caption:=vTglAwal.Text+' s/d '+vTglAkhir.Text;
end;

procedure TLapMutStokDyeingFrm.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLapMutStokDyeingFrm.PageFooterBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  DMFrm.QDateTime.Open;
end;

procedure TLapMutStokDyeingFrm.QuickRep1AfterPreview(Sender: TObject);
begin
  LapMutStokDyeingFrm :=Nil;
end;

procedure TLapMutStokDyeingFrm.QuickRep1AfterPrint(Sender: TObject);
begin
  LapMutStokDyeingFrm :=Nil;
end;

procedure TLapMutStokDyeingFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
{  QTotal.Close;
...
procedure TLapMutStokDyeingFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
...
procedure TLapMutStokDyeingFrm.wwDBGrid2UpdateFooter(Sender: TObject);
...
procedure TLapMutStokDyeingFrm.SummaryBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  DMFrm.QDateTime.Open;
end;

procedure TLapMutStokDyeingFrm.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  LapMutStokDyeingFrm :=Nil;
end;

procedure TLapMutStokDyeingFrm.QBrowse2AfterScroll(DataSet: TDataSet);
begin
    LabelBanner.Caption:='Record ke '+IntToStr(QBrowse2.RecNo)+' dari '+FormatFloat('#,#',QBrowse2.RecordCount)+' Records';
end;

procedure TLapMutStokDyeingFrm.QBrowseFilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
   Accept:=
    ((QBrowseQTYAWAL.AsFloat)<>0) or
    ((QBrowseQTY1M.AsFloat)<>0) or
    ((QBrowseQTY2M.AsFloat)<>0) or
    ((QBrowseQTY3M.AsFloat)<>0) or
    ((QBrowseQTY4M.AsFloat)<>0) or
    ((QBrowseQTY1K.AsFloat)<>0) or
    ((QBrowseQTY2K.AsFloat)<>0) or
    ((QBrowseQTY3K.AsFloat)<>0) or
   ((QBrowseQTYAKHIR.AsFloat)<>0)
end;
