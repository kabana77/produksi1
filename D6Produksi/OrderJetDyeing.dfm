object OrderJetDyeingFrm: TOrderJetDyeingFrm
  Left = 247
  Top = 87
  Width = 1010
  Height = 589
  Caption = 'Order Jet Dyeing'
  Color = clBtnFace
  ...
  object PanelMain: TPanel
    ...
    object PanelHeader: TPanel
      ...
      Align = alTop
      BevelOuter = bvNone
      Caption = '810. Terima Order Jet Dyeing'
      Color = clBackground
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -19
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'QTY2'#9'10'#9'Qty'#9'F'#9'MASUK'
              'SATUAN'#9'10'#9'Satuan'#9'T'#9'MASUK'
          ...
          object LookKonstruksi: TwwDBLookupComboDlg
            ...
            MaxHeight = 209
            Selected.Strings = (
              'KD_KONSTRUKSI'#9'6'#9'KODE KONSTRUKSI'#9'F'
              'SUB_KELOMPOK'#9'50'#9'NAMA KONSTRUKSI'#9'F')
        ...
        object PanelBrowse: TPanel
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'QTY2'#9'10'#9'Qty'#9'F'#9'MASUK'
              'SATUAN'#9'10'#9'Satuan'#9'F'#9'MASUK'
              'NO_ORDER'#9'20'#9'NO BUKTI'#9'F'
              'NO_RESEP'#9'22'#9'PENGIRIM'#9'F')
            IniAttributes.Enabled = True
            IniAttributes.SectionName = 'Produksi'
            IniAttributes.Delimiter = ';;'
            IniAttributes.CheckNewFields = True
  ...
  object ppReportInput: TppReport
    ...
    object ppHeaderBand2: TppHeaderBand
      ...
      object ppLabel1: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'TERIMA ORDER JET DYEING'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 16
  ...
  object QBrowse2: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
      4F5354010000000000}
    Cursor = crSQLWait
    ReadOnly = True
    QueryAllRecords = False
  ...
  object QTotal2: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty1) as GULUNG_IN, sum(qty2) as MTR_IN from ipisma_d' +
        'b3.bukti_detail2 a'
      'where ibukti = :ibukti')
  ...
  object QTotalMeter: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(a.qty1) as gulung_in, sum(a.qty2) as MTR_in from ipis' +
      ...
      'and t.kd_transaksi = '#39'810'#39' and t.ispost = 1'
      '')
    Variables.Data = {
