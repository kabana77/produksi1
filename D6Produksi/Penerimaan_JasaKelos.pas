...
type
  TPenerimaan_JasaKelosFrm = class(TForm)
    PanelMain: TPanel;
    PanelHeader: TPanel;
    ...
    QHasilNotaKD_ITEM30: TStringField;
    QHasilNotaKETERANGAN30: TStringField;
    QHasilNotaRASIO: TFloatField;
    QHasilNotaKD_SATUAN: TStringField;
    QHasilNotaNO_BATCH: TStringField;
    QHasilNotaKD_WARNA: TStringField;
    QHasilNotaKG: TFloatField;
    QHasilNotaPCS: TFloatField;
    QHasilNotaKD_ITEM_BENANG: TStringField;
    QHasilNotaNAMA_ITEM_BENANG: TStringField;
    QDetailNO_BUKTI: TStringField;
    QCekNota: TOracleDataSet;
    QCekNotaNoNota: TFloatField;
    ...
    procedure QHasilNotaBeforeOpen(DataSet: TDataSet);
...
var
  Penerimaan_JasaKelosFrm: TPenerimaan_JasaKelosFrm;
...
//  if BPBFrm=Nil then
  begin
    Penerimaan_JasaKelosFrm:=TPenerimaan_JasaKelosFrm.Create(Application);
    Penerimaan_JasaKelosFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       Penerimaan_JasaKelosFrm.QMaster.ReadOnly:=True;
       Penerimaan_JasaKelosFrm.QDetail.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    Penerimaan_JasaKelosFrm.Caption:=UpperCase(pkode+pjudul);
    Penerimaan_JasaKelosFrm.vkode:=pkode;
    Penerimaan_JasaKelosFrm.vjns_lokasi:=pjns_lokasi;
    Penerimaan_JasaKelosFrm.vjns_brg:=pjns_brg;
    Penerimaan_JasaKelosFrm.QTransaksi.Open;

    Penerimaan_JasaKelosFrm.PanelHeader.Caption:=Penerimaan_JasaKelosFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+Penerimaan_JasaKelosFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    Penerimaan_JasaKelosFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    Penerimaan_JasaKelosFrm.wwDBGrid1.IniAttributes.SectionName:=Penerimaan_JasaKelosFrm.Caption+'1';
    Penerimaan_JasaKelosFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    Penerimaan_JasaKelosFrm.wwDBGrid1.LoadFromIniFile;
    Penerimaan_JasaKelosFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    Penerimaan_JasaKelosFrm.wwDBGrid2.IniAttributes.SectionName:=Penerimaan_JasaKelosFrm.Caption+'2';
    Penerimaan_JasaKelosFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    Penerimaan_JasaKelosFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,Penerimaan_JasaKelosFrm.Caption+'1',Penerimaan_JasaKelosFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,Penerimaan_JasaKelosFrm.Caption+'2',Penerimaan_JasaKelosFrm.wwDBGrid2);
    Penerimaan_JasaKelosFrm.wwDBSpinLine1.Value:=Penerimaan_JasaKelosFrm.wwDBGrid1.RowHeightPercent;
    Penerimaan_JasaKelosFrm.wwDBSpinLine2.Value:=Penerimaan_JasaKelosFrm.wwDBGrid2.RowHeightPercent;

  end;

  Penerimaan_JasaKelosFrm.Show;
end;

procedure TPenerimaan_JasaKelosFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'1',wwDBGrid1);
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   Penerimaan_JasaKelosFrm:=Nil;
end;

procedure TPenerimaan_JasaKelosFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TPenerimaan_JasaKelosFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TPenerimaan_JasaKelosFrm.BtnOkClick(Sender: TObject);
var
  vjam : string;
  vjam1,vjam2 : Integer;
begin
...
procedure TPenerimaan_JasaKelosFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TPenerimaan_JasaKelosFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TPenerimaan_JasaKelosFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TPenerimaan_JasaKelosFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TPenerimaan_JasaKelosFrm.vTglAwalChange(Sender: TObject);
begin
  //vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
  vTglAkhir.Date:=(VTglAwal.Date);
end;

procedure TPenerimaan_JasaKelosFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TPenerimaan_JasaKelosFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TPenerimaan_JasaKelosFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TPenerimaan_JasaKelosFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=0;
end;

procedure TPenerimaan_JasaKelosFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TPenerimaan_JasaKelosFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TPenerimaan_JasaKelosFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TPenerimaan_JasaKelosFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TPenerimaan_JasaKelosFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TPenerimaan_JasaKelosFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TPenerimaan_JasaKelosFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TPenerimaan_JasaKelosFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
  ppNo2.AsInteger:=ppNo2.AsInteger+1;
end;

procedure TPenerimaan_JasaKelosFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure TPenerimaan_JasaKelosFrm.BtnPrintInputClick(Sender: TObject);
begin
  ppDBQMaster.Close;
  ppDBQMaster.Open;
  ppDBQDetail.Close;
...
procedure TPenerimaan_JasaKelosFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TPenerimaan_JasaKelosFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TPenerimaan_JasaKelosFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TPenerimaan_JasaKelosFrm.Label5Click(Sender: TObject);
begin
...
procedure TPenerimaan_JasaKelosFrm.LookItemEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TPenerimaan_JasaKelosFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TPenerimaan_JasaKelosFrm.QMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TPenerimaan_JasaKelosFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TPenerimaan_JasaKelosFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TPenerimaan_JasaKelosFrm.FormCloseQuery(Sender: TObject;
...
procedure TPenerimaan_JasaKelosFrm.QMasterAfterPost(DataSet: TDataSet);
begin
  PageControl1.Pages[1].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
  PageControl1.Pages[2].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
end;

procedure TPenerimaan_JasaKelosFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TPenerimaan_JasaKelosFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TPenerimaan_JasaKelosFrm.QLokasiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TPenerimaan_JasaKelosFrm.LookLokasiEnter(Sender: TObject);
begin
  QLokasi.Open;
end;

procedure TPenerimaan_JasaKelosFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
  if vjns_brg<>'' then
  begin
...
procedure TPenerimaan_JasaKelosFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TPenerimaan_JasaKelosFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TPenerimaan_JasaKelosFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TPenerimaan_JasaKelosFrm.FormShow(Sender: TObject);
begin
...
procedure TPenerimaan_JasaKelosFrm.LookWarnaEnter(Sender: TObject);
begin
  DMFrm.QWarna.Open;
end;

procedure TPenerimaan_JasaKelosFrm.QHasilNotaBeforeOpen(
  DataSet: TDataSet);
begin
  QHasilNota.SetVariable('NO_NOTA',wwDBEdit1.Text);
end;

procedure TPenerimaan_JasaKelosFrm.Button1Click(Sender: TObject);
begin
  ...
  begin
      ...
      QDetail.Close;
      QDetail.Open;
      if QHasilNota.IsEmpty then
        ShowMessage('No Nota tidak ada !')
        else
        begin

        QCekNota.Close;
        QCekNota.SetVariable('NO_NOTA',wwDBEdit1.Text);
        QCekNota.Open;
        if QCekNotaNoNota.AsInteger>1 then       //>1
          ...
          if QCekItemKELJMLNULL.AsInteger>0 then     //>0
            ...
            while not QHasilNota.Eof do
            begin
              QDetail.Insert;
              QDetailKD_ITEM.AsString:=QHasilNotaKD_ITEM_BENANG.AsString;
    					QDetailKETERANGAN.AsString:=QHasilNotaNAMA_ITEM_BENANG.AsString;
    					QDetailRASIO.AsFloat:=QHasilNotaRASIO.AsFloat;
    					QDetailKD_SATUAN.AsString:=QHasilNotaKD_SATUAN.AsString;
              QDetailNO_BATCH.AsString:=QHasilNotaNO_BATCH.AsString;
              QDetailNO_BUKTI.AsString:=QHasilNotaKD_ITEM30.AsString;
              QDetailQTY1.AsFloat:=QHasilNotaKG.AsFloat;
              QDetailQTY6.AsFloat:=QHasilNotaPCS.AsFloat;   //ATAU MENGIKUTI KALKLULASI RASIO ??
              QDetailKD_WARNA.AsString:=QHasilNotaKD_WARNA.AsString;
...
procedure TPenerimaan_JasaKelosFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TPenerimaan_JasaKelosFrm.QMasterApplyRecord(
...
procedure TPenerimaan_JasaKelosFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TPenerimaan_JasaKelosFrm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TPenerimaan_JasaKelosFrm.cbTransaksiCloseUp(
...
procedure TPenerimaan_JasaKelosFrm.QDetailAfterDelete(DataSet: TDataSet);
begin
...
procedure TPenerimaan_JasaKelosFrm.QDetailQTY6Change(Sender: TField);
begin
//MAA 13-01-2020
...
procedure TPenerimaan_JasaKelosFrm.QDetailApplyRecord(
  Sender: TOracleDataSet; Action: Char; var Applied: Boolean;
  var NewRowId: String);
begin
 if QDetailRASIO.AsFloat>0 then
