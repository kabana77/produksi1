...
var
  TerimaMaklonFrm: TTerimaMaklonFrm;
...
//  if BPBFrm=Nil then
  begin
    TerimaMaklonFrm:=TTerimaMaklonFrm.Create(Application);
    TerimaMaklonFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       TerimaMaklonFrm.QMaster.ReadOnly:=True;
       TerimaMaklonFrm.QDetail.ReadOnly:=True;
    end;

    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    TerimaMaklonFrm.Caption:=UpperCase(pjudul);
    TerimaMaklonFrm.vkode:=pkode;
    TerimaMaklonFrm.vjns_lokasi:=pjns_lokasi;
    TerimaMaklonFrm.vjns_brg:=pjns_brg;
    //TerimaMaklonFrm.vkd_sub_lokasi:=pkd_sub_lokasi;
  // TerimaMaklonFrm.vjns_brg:='21';
    TerimaMaklonFrm.QTransaksi.Open;

    TerimaMaklonFrm.PanelHeader.Caption:=TerimaMaklonFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+TerimaMaklonFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    TerimaMaklonFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    TerimaMaklonFrm.wwDBGrid1.IniAttributes.SectionName:=TerimaMaklonFrm.Caption+'1';
    TerimaMaklonFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    TerimaMaklonFrm.wwDBGrid1.LoadFromIniFile;
    TerimaMaklonFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    TerimaMaklonFrm.wwDBGrid2.IniAttributes.SectionName:=TerimaMaklonFrm.Caption+'2';
    TerimaMaklonFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    TerimaMaklonFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,TerimaMaklonFrm.Caption+'1',TerimaMaklonFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,TerimaMaklonFrm.Caption+'2',TerimaMaklonFrm.wwDBGrid2);
    TerimaMaklonFrm.wwDBSpinLine1.Value:=TerimaMaklonFrm.wwDBGrid1.RowHeightPercent;
    TerimaMaklonFrm.wwDBSpinLine2.Value:=TerimaMaklonFrm.wwDBGrid2.RowHeightPercent;

  end;

  TerimaMaklonFrm.Show;
end;

procedure TTerimaMaklonFrm.FormClose(Sender: TObject;
...
procedure TTerimaMaklonFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TTerimaMaklonFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TTerimaMaklonFrm.BtnOkClick(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vjam : string;
...
procedure TTerimaMaklonFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TTerimaMaklonFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TTerimaMaklonFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TTerimaMaklonFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TTerimaMaklonFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TTerimaMaklonFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TTerimaMaklonFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TTerimaMaklonFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TTerimaMaklonFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=0;
end;

procedure TTerimaMaklonFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TTerimaMaklonFrm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TTerimaMaklonFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TTerimaMaklonFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TTerimaMaklonFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TTerimaMaklonFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
{  if key=13 then
  begin
...
procedure TTerimaMaklonFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TTerimaMaklonFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TTerimaMaklonFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
  ppNo2.AsInteger:=ppNo2.AsInteger+1;
end;

procedure TTerimaMaklonFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure TTerimaMaklonFrm.BtnPrintInputClick(Sender: TObject);
begin
  ppDBQMaster.Close;
  ppDBQMaster.Open;
  ppDBQDetail.Close;
...
procedure TTerimaMaklonFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TTerimaMaklonFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TTerimaMaklonFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TTerimaMaklonFrm.Label5Click(Sender: TObject);
begin
...
procedure TTerimaMaklonFrm.LookItemEnter(Sender: TObject);
var
tgl_awal : tdatetime;
begin
  QItem.Close;
  if QMasterJENIS.AsString='CELUP' then
    begin
     ...
     QItem.SQL.Text:='select a.kd_item, a.nama_item, a.kd_satuan, a.rasio, d.satuan, a.min_stok, a.kd_jns_item, c.kd_sub_lokasi'+
      ...
      ' where '+
      ' a.kd_satuan=d.kd_satuan and c.jns_lokasi=''PROSES'' and'+
      ' a.kd_jns_item=''21'' and c.kd_lokasi=''21'' '+
  ...
  if QMasterJENIS.AsString='PENGERING' then
    begin
      ...
      ' where '+
      ' a.kd_satuan=d.kd_satuan and c.jns_lokasi=''PROSES'' and'+
      ' a.kd_jns_item=''22'' and c.kd_lokasi=''22'' '+
      ' and a.kd_item <>''21.14581'' '+
      ' group by a.kd_item, a.nama_item, a.kd_satuan, a.rasio,d.satuan, a.min_stok, a.kd_jns_item, c.kd_sub_lokasi';
     QItem.open;
   end
...
procedure TTerimaMaklonFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TTerimaMaklonFrm.QMasterNewRecord(DataSet: TDataSet);
begin
  ...
  wwDBDateTimePicker1.Enabled:=True;
    ...
    if QMasterKD_TRANSAKSI.AsString='797' then
    begin
...
procedure TTerimaMaklonFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TTerimaMaklonFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TTerimaMaklonFrm.FormCloseQuery(Sender: TObject;
...
procedure TTerimaMaklonFrm.QMasterAfterPost(DataSet: TDataSet);
begin
  PageControl1.Pages[1].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
  PageControl1.Pages[2].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
end;

procedure TTerimaMaklonFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TTerimaMaklonFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TTerimaMaklonFrm.QLokasiBeforeOpen(DataSet: TDataSet);
var
  myvjns_lokasi : string;
begin
  if vjns_lokasi='40' then
    myvjns_lokasi:='22' else
  if vjns_lokasi='40' then
   myvjns_lokasi:='21';
  QLokasi.DeclareVariable('vjns_lokasi',otSubst);
  QLokasi.SQL.Text:='select * from '+cUserTabel+'sub_lokasi where jns_lokasi=''LOKASI'' and kd_lokasi in (''21'',''22'') ';
  QLokasi.SetVariable('vjns_lokasi',myvjns_lokasi);
end;

procedure TTerimaMaklonFrm.LookLokasiEnter(Sender: TObject);
begin
  QLokasi.Close;
  QLokasi.Open;
end;

procedure TTerimaMaklonFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
...
procedure TTerimaMaklonFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TTerimaMaklonFrm.QDetailNewRecord(DataSet: TDataSet);
begin
  QDetailQTY1.AsFloat:=0;
  ...
  QDetailKD_SUB_LOKASI.AsString:='40-10000';
  QDetailKD_SUB_LOKASI2.AsString:='22-00000';
...
procedure TTerimaMaklonFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TTerimaMaklonFrm.TabSheet3Show(Sender: TObject);
begin
...
procedure TTerimaMaklonFrm.LookWarnaEnter(Sender: TObject);
begin
  DMFrm.QWarna.Open;
end;

procedure TTerimaMaklonFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TTerimaMaklonFrm.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  DMFrm.QDateTime.Open;
end;

procedure TTerimaMaklonFrm.QRBand6BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  DMFrm.QDateTime.Open;
end;

procedure TTerimaMaklonFrm.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLPeriode1.Caption:=vTglAwal.Text+' s/d '+vTglAkhir.Text;
end;

procedure TTerimaMaklonFrm.wwDBDateTimePicker1Change(Sender: TObject);
begin
  QItem.Refresh;
end;

procedure TTerimaMaklonFrm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TTerimaMaklonFrm.QMasterAfterDelete(DataSet: TDataSet);
begin
  wwDBDateTimePicker1.Enabled:=False;

end;

procedure TTerimaMaklonFrm.JUDULPRINTGetText(Sender: TObject;
  var Text: String);
begin
   if QMasterJENIS.AsString='CELUP' then
    begin
...
procedure TTerimaMaklonFrm.LookupWarna2Enter(Sender: TObject);
begin
  DMFrm.QWarna.Close;
