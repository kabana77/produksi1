object KoreksiKeluarJDFrm: TKoreksiKeluarJDFrm
  Left = 179
  Top = 305
  Width = 1010
  Height = 589
  Caption = 'Koreksi Keluar Jet Dyeing'
  Color = clBtnFace
  ...
  object PanelMain: TPanel
    ...
    object PanelHeader: TPanel
      ...
      Align = alTop
      BevelOuter = bvNone
      Caption = '814. Koreksi Keluar Jet Dyeing'
      Color = clBackground
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -19
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'NAMA_KONSTRUKSI'#9'30'#9'Nama'#9'T'#9'KONSTRUKSI'
              'SATUAN'#9'10'#9'Satuan'#9'T'
              'QTY10'#9'10'#9'KELUAR~(Qty)'#9'F'
              'NO_ORDER'#9'25'#9'NO BUKTI'#9'T')
  ...
  object QKonstruksi: TOracleDataSet
    SQL.Strings = (
      ...
      'from ipisma_db3.VKONSTRUKSI_JETDYEING a, ipisma_db3.gd_stok2 b'
        ...
        'kd_item1 like '#39'810%'#39' or b.kd_item2 like '#39'810%'#39') --and qty != 0'
    ...
    Session = DMFrm.OS
    BeforeOpen = QKonstruksiBeforeOpen
    Left = 440
    Top = 80
  ...
  object QBrowse2: TOracleDataSet
    ...
    object QBrowse2QTY9: TFloatField
      FieldName = 'QTY9'
    end
    object QBrowse2QTY10: TFloatField
      FieldName = 'QTY10'
    end
  ...
  object QDetail2: TOracleDataSet
    ...
    object QDetail2QTY9: TFloatField
      FieldName = 'QTY9'
    end
    object QDetail2QTY10: TFloatField
      FieldName = 'QTY10'
    end
  ...
  object QTotal2: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty9) as GULUNG_IN, sum(qty10) as MTR_IN from ipisma_' +
        'db3.bukti_detail2 a'
      'where ibukti = :ibukti')
  ...
  object QTotalMeter: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(a.qty9) as gulung_in, sum(a.qty10) as MTR_in from ipi' +
        'sma_db3.bukti_detail2 a, ipisma_db3.bukti2 t'
      
        'where t.ibukti = a.ibukti and trunc(t.tgl) >= :pawal and trunc(t' +
        '.tgl) <= :pakhir and satuan = '#39'METER'#39
      'and t.kd_transaksi = '#39'814'#39' and t.ispost = 1'
      '')
    Variables.Data = {
