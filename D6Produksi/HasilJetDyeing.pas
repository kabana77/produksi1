...
type
  THasilJetDyeingFrm = class(TForm)
    ...
    LookWarnaa: TwwDBLookupComboDlg;
    QBrowse2QTY3: TFloatField;
    QBrowse2QTY4: TFloatField;
...
var
  HasilJetDyeingFrm: THasilJetDyeingFrm;

procedure ShowForm(pNamaMenu:String; pkode : String; pjudul : string; pjns_brg : String; pjns_lokasi : String);

implementation

uses DM, Pembelian, OrderJetDyeing;

{$R *.dfm}
procedure THasilJetDyeingFrm.totalSatuan;
begin
  QTotalMeter.Close;
  QTotalPotong.Close;
...
//  if BPBFrm=Nil then
  begin
    HasilJetDyeingFrm:=THasilJetDyeingFrm.Create(Application);
    HasilJetDyeingFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       HasilJetDyeingFrm.QMaster2.ReadOnly:=True;
       HasilJetDyeingFrm.QDetail2.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    HasilJetDyeingFrm.Caption:=UpperCase(pjudul);
    HasilJetDyeingFrm.vkode:=pkode;
    HasilJetDyeingFrm.vjns_lokasi:=pjns_lokasi;
    HasilJetDyeingFrm.vjns_brg:=pjns_brg;
    HasilJetDyeingFrm.QTransaksi.Open;

    HasilJetDyeingFrm.Caption:=UpperCase(pjudul);
//    HasilJetDyeingFrm.PanelHeader.Caption:=HasilJetDyeingFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+HasilJetDyeingFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    HasilJetDyeingFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    HasilJetDyeingFrm.wwDBGrid1.IniAttributes.SectionName:=HasilJetDyeingFrm.Caption+'1';
    HasilJetDyeingFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    HasilJetDyeingFrm.wwDBGrid1.LoadFromIniFile;
    HasilJetDyeingFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    HasilJetDyeingFrm.wwDBGrid2.IniAttributes.SectionName:=HasilJetDyeingFrm.Caption+'2';
    HasilJetDyeingFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    HasilJetDyeingFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,HasilJetDyeingFrm.Caption+'1',HasilJetDyeingFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,HasilJetDyeingFrm.Caption+'2',HasilJetDyeingFrm.wwDBGrid2);
    HasilJetDyeingFrm.wwDBSpinLine1.Value:=HasilJetDyeingFrm.wwDBGrid1.RowHeightPercent;
    HasilJetDyeingFrm.wwDBSpinLine2.Value:=HasilJetDyeingFrm.wwDBGrid2.RowHeightPercent;

  end;

  HasilJetDyeingFrm.Show;
end;

procedure THasilJetDyeingFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'1',wwDBGrid1);
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   HasilJetDyeingFrm:=Nil;
end;

procedure THasilJetDyeingFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure THasilJetDyeingFrm.BtnExportClick(Sender: TObject);
begin
...
procedure THasilJetDyeingFrm.BtnOkClick(Sender: TObject);
var
  i : word;
  vpertama : boolean;
  vjam : string;
...
procedure THasilJetDyeingFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure THasilJetDyeingFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure THasilJetDyeingFrm.TabSheet1Show(Sender: TObject);
begin
  QMaster2.Close;
...
procedure THasilJetDyeingFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure THasilJetDyeingFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
  ppNo2.AsInteger:=ppNo2.AsInteger+1;
end;

procedure THasilJetDyeingFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure THasilJetDyeingFrm.BtnPrintInputClick(Sender: TObject);
begin
  ppReportInput.Print;
end;

procedure THasilJetDyeingFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure THasilJetDyeingFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure THasilJetDyeingFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure THasilJetDyeingFrm.Label5Click(Sender: TObject);
begin
...
procedure THasilJetDyeingFrm.LookKonstruksiEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure THasilJetDyeingFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure THasilJetDyeingFrm.QMasterNewRecord(DataSet: TDataSet);
begin
...
procedure THasilJetDyeingFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure THasilJetDyeingFrm.ppPageStyle1BeforePrint(Sender: TObject);
begin
  ppNo2.AsInteger:=0;
end;

procedure THasilJetDyeingFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure THasilJetDyeingFrm.FormCloseQuery(Sender: TObject;
...
procedure THasilJetDyeingFrm.QMasterAfterPost(DataSet: TDataSet);
begin
{  PageControl1.Pages[1].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
  PageControl1.Pages[2].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');}
end;

procedure THasilJetDyeingFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure THasilJetDyeingFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure THasilJetDyeingFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
{    QItem.SetVariable('pkd_lokasi',vjns_lokasi);
    QItem.SetVariable('psysdate',Trunc(QMasterTGL.AsDateTime));}
end;

procedure THasilJetDyeingFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
{  if modified then
  begin
...
procedure THasilJetDyeingFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure THasilJetDyeingFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure THasilJetDyeingFrm.QDetailCalcFields(DataSet: TDataSet);
begin
{  QDetailSELISIH.AsFloat:=QDetailQTY1.AsFloat-
    QDetailQTY2.AsFloat; }
end;

procedure THasilJetDyeingFrm.TabSheet3Show(Sender: TObject);
begin
...
procedure THasilJetDyeingFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
{  QTotal.Close;
...
procedure THasilJetDyeingFrm.QMaster2AfterPost(DataSet: TDataSet);
begin
...
procedure THasilJetDyeingFrm.QMaster2BeforeDelete(DataSet: TDataSet);
begin
...
procedure THasilJetDyeingFrm.QMaster2BeforeEdit(DataSet: TDataSet);
begin
  if QMaster2ISPOST.AsString='1' then
  begin
     ShowMessage('Maaf, sudah di-POST !, tidak bisa diubah...');
...
procedure THasilJetDyeingFrm.QMaster2BeforeInsert(DataSet: TDataSet);
begin
  if DataSet['ISPOST']='0' then
  begin
    if MessageDlg('Data belum di-POSTING, batalkan ?', mtWarning, [mbYes, mbNo],0)=mrYes then
...
procedure THasilJetDyeingFrm.QMaster2BeforePost(DataSet: TDataSet);
begin
...
procedure THasilJetDyeingFrm.QMaster2NewRecord(DataSet: TDataSet);
begin
...
procedure THasilJetDyeingFrm.QDetail2BeforeDelete(DataSet: TDataSet);
begin
  if QMaster2ISPOST.AsString='1' then
  begin
     ShowMessage('Maaf, sudah di-POST !, tidak bisa diubah...');
...
procedure THasilJetDyeingFrm.QDetail2BeforeEdit(DataSet: TDataSet);
begin
  if QMaster2ISPOST.AsString='1' then
  begin
     ShowMessage('Maaf, sudah di-POST !, tidak bisa diubah...');
...
procedure THasilJetDyeingFrm.QDetail2BeforeInsert(DataSet: TDataSet);
begin
  if QMaster2ISPOST.AsString='1' then
  begin
     ShowMessage('Maaf, sudah di-POST !, tidak bisa diubah...');
...
procedure THasilJetDyeingFrm.QDetail2BeforePost(DataSet: TDataSet);
begin
  ...
  if QDetail2QTY4.Asfloat>QKonstruksiQTY.Asfloat then
     begin
        ShowMessage('Hasil tidak boleh lebih besar penerimaan !');
        Abort;
     end;
end;

procedure THasilJetDyeingFrm.QDetail2CalcFields(DataSet: TDataSet);
begin
{  QDetail2SELISIH.AsFloat:=QDetail2QTY1.AsFloat-
    QDetail2QTY2.AsFloat; }
end;

procedure THasilJetDyeingFrm.QDetail2NewRecord(DataSet: TDataSet);
begin
  QDetail2QTY3.AsFloat:=0;
  QDetail2QTY4.AsFloat:=0;
  QDetail2IBUKTI.AsInteger:=QMaster2IBUKTI.AsInteger;
end;

procedure THasilJetDyeingFrm.QBrowse2AfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse2.RecNo)+' dari '+FormatFloat('#,#',QBrowse2.RecordCount)+' Records';
end;

procedure THasilJetDyeingFrm.LookWrnaCloseUp(Sender: TObject;
...
procedure THasilJetDyeingFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
{
  QTotal.Close;
  QTotal.SetVariable('pawal',vTglAwal.Date);
...
procedure THasilJetDyeingFrm.LookKonstruksiCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure THasilJetDyeingFrm.LookWarnaaCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure THasilJetDyeingFrm.LookWarnaaEnter(Sender: TObject);
begin
