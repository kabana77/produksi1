object LapMutStokDyeingFrm: TLapMutStokDyeingFrm
  Left = 187
  Top = 110
  Width = 1177
  Height = 628
  Caption = 'Laporan Mutasi Stok Dept Dyeing'
  Color = clBtnFace
    ...
    object PanelBrowse: TPanel
      ...
      object PageControl1: TPageControl
        ...
        object TabSheet1: TTabSheet
          Caption = 'Laporan Mutasi Stok SOFTCONE'
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'QTY1M'#9'14'#9'GUDANG~BENANG GREY'#9'F'#9'PEMASUKAN'
              'QTY2M'#9'14'#9'KOREKSI~MASUK'#9'F'#9'PEMASUKAN'
              'QTY3M'#9'14'#9'PROSES~ULANG'#9'F'#9'PEMASUKAN'
              'QTY4M'#9'14'#9'RETURN~GUDANG WARNA'#9'F'#9'PEMASUKAN'
              'QTY1K'#9'14'#9'CELUP'#9'F'#9'PENGELUARAN'
              'QTY2K'#9'14'#9'KELUAR~PROSES KE GW'#9'F'#9'PENGELUARAN'
              'QTY3K'#9'14'#9'KOREKSI~KELUAR'#9'F'#9'PENGELUARAN'
        ...
        object TabSheet2: TTabSheet
          Caption = 'Laporan Mutasi Stok CELUP'
          ImageIndex = 1
          object wwDBGrid2: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'QTY5M'#9'14'#9'KOREKSI~MASUK'#9'F'#9'PEMASUKAN'
              'QTY1K'#9'14'#9'GUDANG WARNA'#9'F'#9'PENGELUARAN'
              'QTY2K'#9'14'#9'PROSES ULANG'#9'F'#9'PENGELUARAN'
              'QTY5K'#9'14'#9'KOREKSI~KELUAR'#9'F'#9'PENGELUARAN'
              'QTYAKHIR'#9'15'#9'AKHIR'#9'F')
            IniAttributes.Enabled = True
            IniAttributes.Delimiter = ';;'
            IniAttributes.CheckNewFields = True
  ...
  object QDump: TOracleQuery
    SQL.Strings = (
      'begin'
      'commit;'
      '  ipisma_db3.proc_lap_mut_stok_p1_SC(:vsysdate, :vsysdate2);'
      'end;'
      '')
    Session = DMFrm.OS
    Variables.Data = {
