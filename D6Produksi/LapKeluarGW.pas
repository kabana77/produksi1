...
var
  LapKeluarGWFrm: TLapKeluarGWFrm;
...
//  if InfoWIPPengeringanFrm=Nil then
  begin
    LapKeluarGWFrm:=TLapKeluarGWFrm.Create(Application);
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    LapKeluarGWFrm.vkode:=pbrg;
    LapKeluarGWFrm.QTransaksi.Open;


    LapKeluarGWFrm.PanelHeader.Caption:=pjudul;
    LapKeluarGWFrm.Caption:=UpperCase(LapKeluarGWFrm.PanelHeader.Caption);
...
procedure TLapKeluarGWFrm.FormClose(Sender: TObject;
...
procedure TLapKeluarGWFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TLapKeluarGWFrm.BtnExportClick(Sender: TObject);
begin
  ...
  begin
     ...
     wwDBGrid1.ExportOptions.TitleName:='LAPORAN PENGELUARAN GUDANG WARNA';
...
procedure TLapKeluarGWFrm.BtnOkClick(Sender: TObject);
var
...
ShowMessage('Waktunya input data !!! Silahkan Browse lagi Setelah Jam 11');
Qbrowse.Close;
abort;
end
else
...
procedure TLapKeluarGWFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TLapKeluarGWFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TLapKeluarGWFrm.wwDBSpinLine2Change(Sender: TObject);
begin
//    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TLapKeluarGWFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TLapKeluarGWFrm.BtnOk2Click(Sender: TObject);
begin
...
procedure TLapKeluarGWFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  QuickRep1.Preview;
end;

procedure TLapKeluarGWFrm.BtnPrintBrowse1Click(Sender: TObject);
var checbox : byte;
begin

end;

procedure TLapKeluarGWFrm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TLapKeluarGWFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TLapKeluarGWFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TLapKeluarGWFrm.Label5Click(Sender: TObject);
begin
...
procedure TLapKeluarGWFrm.LookItemEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TLapKeluarGWFrm.ppDetailBand1BeforePrint(Sender: TObject);
begin
 ppLblNomer.Caption:=IntToStr(ppDBQBrowseDetail.RecordNo+1)
end;

procedure TLapKeluarGWFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TLapKeluarGWFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TLapKeluarGWFrm.FormShow(Sender: TObject);
begin
...
procedure TLapKeluarGWFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
    LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TLapKeluarGWFrm.BitBtnPrint2Click(Sender: TObject);
begin
  QuickRep2.Preview;
end;

procedure TLapKeluarGWFrm.cbAdaTransaksiClick(Sender: TObject);
begin
//  QBrowse.Filtered:=cbAdaTransaksi.Checked;
end;

procedure TLapKeluarGWFrm.TitleBand1BeforePrint(
...
procedure TLapKeluarGWFrm.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLapKeluarGWFrm.QRBand6BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  DMFrm.QDateTime.Open;
end;

procedure TLapKeluarGWFrm.QRBand8BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
//  QRLabel55.Caption:=vTglAwal.Text+' s/d '+vTglAkhir.Text;
end;

procedure TLapKeluarGWFrm.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TLapKeluarGWFrm.PageFooterBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  DMFrm.QDateTime.Open;
end;

procedure TLapKeluarGWFrm.QuickRep1AfterPreview(Sender: TObject);
begin
  LapProduksiFrm :=Nil;
end;

procedure TLapKeluarGWFrm.QuickRep1AfterPrint(Sender: TObject);
begin
  LapProduksiFrm :=Nil;
end;

procedure TLapKeluarGWFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
{  QTotal.Close;
...
procedure TLapKeluarGWFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
...
procedure TLapKeluarGWFrm.wwDBGrid2UpdateFooter(Sender: TObject);
...
procedure TLapKeluarGWFrm.SummaryBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  DMFrm.QDateTime.Open;
end;

procedure TLapKeluarGWFrm.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  LapProduksiFrm :=Nil;
end;
