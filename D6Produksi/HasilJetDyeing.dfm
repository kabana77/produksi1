object HasilJetDyeingFrm: THasilJetDyeingFrm
  Left = 246
  Top = 93
  Width = 1010
  Height = 589
  Caption = 'Hasil Jet Dyeing'
  Color = clBtnFace
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'WARNA'#9'15'#9'Nama Warna'#9'F'#9'WARNA')
          ...
          object LookKonstruksi: TwwDBLookupComboDlg
            ...
            Selected.Strings = (
              ...
              'SUB_KELOMPOK'#9'50'#9'KONSTRUKSI'#9'F'
              'NO_ORDER'#9'50'#9'NO BUKTI'#9'F'
              'QTY'#9'10'#9'QTY'#9'F'
          ...
          object LookWarnaa: TwwDBLookupComboDlg
            Left = 544
            Top = 40
            Width = 65
            Height = 19
            ...
            ShowButton = True
            AllowClearKey = False
            OnCloseUp = LookWarnaaCloseUp
            OnEnter = LookWarnaaEnter
          end
        end
  ...
  object QKonstruksi: TOracleDataSet
    SQL.Strings = (
      'select * from '
        ...
        'sio, b.satuan, sum(b.qty_in2-b.qty_out2) as qty, b.no_order'
      'from IPISMA_DB3.VKONSTRUKSI_JETDYEING a, IPISMA_DB3.gd_stok2 b'
      
        'where a.kd_KONSTRUKSI=b.kd_KONSTRUKSI and b.tgl<=SYSDATE and (kd' +
        '_item1 like '#39'810%'#39' or kd_item2 like '#39'810%'#39')'
      
        'group by a.kd_KONSTRUKSI, a.nama_KONSTRUKSI, a.sub_kelompok, a.r' +
        'asio, b.satuan, (b.no_order)'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      5201000000000005000000524153494F0100000000000C0000005355425F4B45
      4C4F4D504F4B010000000000}
    Cursor = crSQLWait
    ReadOnly = True
  ...
  object QBrowse2: TOracleDataSet
    ...
    object QBrowse2QTY3: TFloatField
      FieldName = 'QTY3'
    end
    object QBrowse2QTY4: TFloatField
      FieldName = 'QTY4'
    end
  ...
  object QTotal2: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(qty3) as GULUNG_IN, sum(qty4) as MTR_IN from ipisma_d' +
        'b3.bukti_detail2 a'
      'where ibukti = :ibukti')
  ...
  object QTotalMeter: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(a.qty3) as gulung_in, sum(a.qty4) as MTR_in from ipis' +
      ...
      'and t.kd_transaksi = '#39'811'#39' and t.ispost = 1'
      '')
    Variables.Data = {
