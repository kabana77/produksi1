...
type
  TKartuStokCelupFrm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
    PanelMain: TPanel;
    PanelHeader: TPanel;
    ...
    ppLabel1: TppLabel;
    CheckBox2: TCheckBox;
    QBrowseAWALKG: TFloatField;
    QBrowseMASUKKG: TFloatField;
    QBrowseAKHIRKG: TFloatField;
    QBrowseKELUARKG: TFloatField;
    ppDBText3: TppDBText;
    ppLabel18: TppLabel;
...
var
  KartuStokCelupFrm: TKartuStokCelupFrm;
...
//  if KartuStokCelupFrm=Nil then
  begin
    KartuStokCelupFrm:=TKartuStokCelupFrm.Create(Application);
    mychar:=pjns;
    Delete(mychar,Pos('&',mychar),1);
    pjns:=mychar;
    KartuStokCelupFrm.Caption:='Barang '+pjns;
    KartuStokCelupFrm.vbrg:=UpperCase(pjns);
    KartuStokCelupFrm.vitem:=copy(pJns,1,2);
    KartuStokCelupFrm.vjns:=copy(pJns,1,2);
    KartuStokCelupFrm.PanelHeader.Caption:=UpperCase(pjns);
    KartuStokCelupFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    KartuStokCelupFrm.wwDBGrid1.IniAttributes.SectionName:=KartuStokCelupFrm.Caption+'1';
    KartuStokCelupFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    KartuStokCelupFrm.wwDBGrid1.LoadFromIniFile;
    KartuStokCelupFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    KartuStokCelupFrm.wwDBGrid2.IniAttributes.SectionName:=KartuStokCelupFrm.Caption+'2';
    KartuStokCelupFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    KartuStokCelupFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,KartuStokCelupFrm.Caption+'1',KartuStokCelupFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,KartuStokCelupFrm.Caption+'2',KartuStokCelupFrm.wwDBGrid2);
    KartuStokCelupFrm.wwDBSpinLine1.Value:=KartuStokCelupFrm.wwDBGrid1.RowHeightPercent;
    KartuStokCelupFrm.wwDBSpinLine2.Value:=KartuStokCelupFrm.wwDBGrid2.RowHeightPercent;
  end;
  KartuStokCelupFrm.Show;
//  KartuStokCelupFrm.Free;
end;

procedure TKartuStokCelupFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'1',wwDBGrid1);
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   KartuStokCelupFrm:=Nil;
end;

procedure TKartuStokCelupFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TKartuStokCelupFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TKartuStokCelupFrm.BtnOkClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ...
    begin
      ...
      if vorder='' then vorder:=' order by a.nama_item';
      QBrowse.Close;
...
procedure TKartuStokCelupFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKartuStokCelupFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse.RecNo)+' dari '+FormatFloat('#,#',QBrowse.RecordCount)+' Records';
end;

procedure TKartuStokCelupFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TKartuStokCelupFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TKartuStokCelupFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TKartuStokCelupFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TKartuStokCelupFrm.BtnOk2Click(Sender: TObject);
begin
  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TKartuStokCelupFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
//  ppNo.AsInteger:=0;
end;

procedure TKartuStokCelupFrm.BtnPrintBrowseClick(Sender: TObject);
begin
...
procedure TKartuStokCelupFrm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TKartuStokCelupFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.Report:=ppReportBrowse;
  ppDesigner1.ShowModal;
end;

procedure TKartuStokCelupFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
  ppNamaLaporan.Caption:='STOK '+UpperCase(Caption);
...
procedure TKartuStokCelupFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TKartuStokCelupFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TKartuStokCelupFrm.TabSheet1Show(Sender: TObject);
begin
...
procedure TKartuStokCelupFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TKartuStokCelupFrm.BtnPrintInputClick(Sender: TObject);
begin
  ppReportInput.Print;
end;

procedure TKartuStokCelupFrm.FormShow(Sender: TObject);
begin
  PanelHeader.Caption:=UpperCase(Caption)+' '+vbrg;
end;

procedure TKartuStokCelupFrm.BtnDesign1Click(Sender: TObject);
begin
  ppDesigner1.Report:=ppReportInput;
  ppDesigner1.ShowModal;
end;

procedure TKartuStokCelupFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
  vnomer:=vnomer+1;
...
procedure TKartuStokCelupFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TKartuStokCelupFrm.Label5Click(Sender: TObject);
begin
...
procedure TKartuStokCelupFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TKartuStokCelupFrm.BtnAmbilDataClick(Sender: TObject);
begin
...
procedure TKartuStokCelupFrm.QBrowseCalcFields(DataSet: TDataSet);
begin
  QBrowseAKHIR.AsFloat:=
  QBrowseAWAL.AsFloat+
    QBrowseMASUK.AsFloat-QBrowseKELUAR.AsFloat;
  QBrowseAWALKG.AsFloat:=QBrowseAWAL.AsFloat/1000;
  QBrowseMASUKKG.AsFloat:=QBrowseMASUK.AsFloat/1000;
  QBrowseKELUARKG.AsFloat:=QBrowseKELUAR.AsFloat/1000;
  QBrowseAKHIRKG.AsFloat:=QBrowseAKHIR.AsFloat/1000;
end;

procedure TKartuStokCelupFrm.TabSheet2Show(Sender: TObject);
begin
...
procedure TKartuStokCelupFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TKartuStokCelupFrm.ppTitleBand3BeforePrint(Sender: TObject);
begin
...
procedure TKartuStokCelupFrm.QBrowseFilterRecord(DataSet: TDataSet;
  var Accept: Boolean);
begin
  Accept:=(Dataset['MASUK']>0) or (Dataset['KELUAR']>0);
end;

procedure TKartuStokCelupFrm.ppSummaryBand2BeforePrint(Sender: TObject);
begin
