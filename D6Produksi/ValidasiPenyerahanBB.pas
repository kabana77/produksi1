...
procedure TValidasiPenyerahanBBFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TValidasiPenyerahanBBFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TValidasiPenyerahanBBFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TValidasiPenyerahanBBFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
  ppNo2.AsInteger:=ppNo2.AsInteger+1;
end;

procedure TValidasiPenyerahanBBFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure TValidasiPenyerahanBBFrm.BtnPrintInputClick(Sender: TObject);
begin
  ppDBQMaster.Close;
  ppDBQMaster.Open;
  ppDBQDetail.Close;
...
//   wwDBGrid1.ColumnByName('QTY1').ReadOnly:=False;    } //270524 hsl meeting, agar KG bisa diedit
...
procedure TValidasiPenyerahanBBFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
...
procedure TValidasiPenyerahanBBFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
  QTotal.Close;
...
procedure TValidasiPenyerahanBBFrm.QMasterApplyRecord(
...
procedure TValidasiPenyerahanBBFrm.vTglAkhirChange(Sender: TObject);
begin
...
procedure TValidasiPenyerahanBBFrm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TValidasiPenyerahanBBFrm.cbTransaksiCloseUp(
...
if (QTransaksiKD_TRANSAKSI.AsString='884') and (cbtransaksi.Text='KOREKSI') then
   ...
   wwDBGrid1.ColumnByName('QTY1').ReadOnly:=True;    }      //270524 hsl meeting, agar KG bisa diedit
...
procedure TValidasiPenyerahanBBFrm.QDetailAfterDelete(DataSet: TDataSet);
begin
...
procedure TValidasiPenyerahanBBFrm.QDetailQTY6Change(Sender: TField);
begin
//MAA 13-01-2020
       QDetailQTY1.AsFloat:=QDetailRASIO.AsFloat*QDetailQTY6.AsFloat;
