object KeluarJetDyeingFrm: TKeluarJetDyeingFrm
  Left = 192
  Top = 121
  Width = 1010
  Height = 596
  Caption = 'Keluar Jet Dyeing'
  Color = clBtnFace
  ...
  object PanelMain: TPanel
    ...
    object PanelHeader: TPanel
      ...
      Align = alTop
      BevelOuter = bvNone
      Caption = '812. Pengeluaran Jet Dyeing'
      Color = clBackground
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -19
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            ControlType.Strings = (
              ...
              'KD_WARNA;CustomEdit;LookWarnaa;F')
            Selected.Strings = (
              'KD_KONSTRUKSI'#9'6'#9'Kode'#9'T'#9'KONSTRUKSI'
              'NAMA_KONSTRUKSI'#9'35'#9'Nama'#9'T'#9'KONSTRUKSI'
              'SATUAN'#9'10'#9'Satuan'#9'T'
              'QTY6'#9'10'#9'Qty'#9'F'#9'KELUAR'
              'WARNA'#9'15'#9'Warna'#9'F'#9'KELUAR'
        ...
        object PanelBrowse: TPanel
          ...
          object wwDBGrid2: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'SATUAN'#9'10'#9'SATUAN'#9'F'
              'QTY6'#9'10'#9'Qty'#9'F'#9'HASIL'
              'WARNA'#9'20'#9'Warna'#9'F'#9'HASIL'
              'NO_ORDER'#9'20'#9'NO BUKTI'#9'F'
              'GRUP'#9'8'#9'GRUP'#9'F'
              'SHIFT'#9'8'#9'SHIFT'#9'F'
              'NO_RESEP'#9'15'#9'KELUAR KE'#9'F')
            IniAttributes.SectionName = 'Produksi'
            IniAttributes.Delimiter = ';;'
            IniAttributes.CheckNewFields = True
  ...
  object ppReportInput: TppReport
    ...
    object ppHeaderBand2: TppHeaderBand
      ...
      object ppLabel25: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'Telah dikirim barang-barang berikut :'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
      ...
      object ppLabel40: TppLabel
        ...
        Border.Style = psSolid
        Border.Visible = False
        Caption = 'PENGELUARAN HASIL JET DYEING'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 16
  ...
  object QKonstruksi: TOracleDataSet
    SQL.Strings = (
      'select * from '
        ...
        '(select a.kd_KONSTRUKSI, a.nama_KONSTRUKSI, a.sub_kelompok, a.ra' +
        'sio, b.satuan, b.kd_warna, c.warna, sum(b.qty_in2-b.qty_out2) as' +
        ' qty, b.no_order'
      
        'from IPISMA_DB3.VKONSTRUKSI_JETDYEING a, IPISMA_DB3.gd_stok2 b, ' +
        'IPISMA_DB3.WARNA c'
      
        'where a.kd_KONSTRUKSI=b.kd_KONSTRUKSI and b.tgl<=SYSDATE and (b.' +
        'kd_item1 like '#39'811%'#39' or b.kd_item2 like '#39'811%'#39') and c.kd_warna=b' +
        '.kd_warna'
      
        'group by a.kd_KONSTRUKSI, a.nama_KONSTRUKSI, a.sub_kelompok, a.r' +
        'asio, b.satuan, b.kd_warna, c.warna, (b.no_order)'
      'order by b.satuan, a.kd_KONSTRUKSI)'
      'where qty != 0')
    QBEDefinition.QBEFieldDefs = {
      
      454C4F4D504F4B010000000000}
    Cursor = crSQLWait
    ReadOnly = True
    ...
    object QKonstruksiWARNA: TStringField
      DisplayWidth = 20
      FieldName = 'WARNA'
      Size = 50
    end
    ...
    object QKonstruksiQTY: TFloatField
      DisplayWidth = 10
      FieldName = 'QTY'
    end
    object QKonstruksiNO_ORDER: TStringField
    ...
    object QKonstruksiKD_WARNA: TStringField
      FieldName = 'KD_WARNA'
      Visible = False
      Size = 6
    end
  ...
  object QBrowse2: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      41010000000000080000004E4F5F524553455001000000000006000000495350
      4F5354010000000000}
    Cursor = crSQLWait
    ReadOnly = True
    QueryAllRecords = False
    ...
    object QBrowse2QTY5: TFloatField
      FieldName = 'QTY5'
    end
    object QBrowse2QTY6: TFloatField
      FieldName = 'QTY6'
    end
    object QBrowse2NO_RESEP: TStringField
      FieldName = 'NO_RESEP'
      Size = 22
    end
  ...
  object QDetail2: TOracleDataSet
    ...
    object QDetail2QTY5: TFloatField
      FieldName = 'QTY5'
    end
    object QDetail2QTY6: TFloatField
      FieldName = 'QTY6'
    end
  ...
  object QTotalMeter: TOracleDataSet
    SQL.Strings = (
        ...
        'select sum(a.qty5) as gulung_in, sum(a.qty6) as MTR_in from ipis' +
      ...
      'and t.kd_transaksi = '#39'812'#39' and t.ispost = 1'
      '')
    Variables.Data = {
