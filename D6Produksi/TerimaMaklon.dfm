object TerimaMaklonFrm: TTerimaMaklonFrm
  Left = 300
  Top = 122
  Width = 1010
  Height = 613
  Caption = 'Terima Maklon'
  Color = clBtnFace
    ...
    object PageControl1: TPageControl
      ...
      object TabSheet1: TTabSheet
        ...
        object PanelDetail: TPanel
          ...
          object LookupWarna2: TwwDBLookupComboDlg
            Left = 256
            Top = 112
            Width = 121
            Height = 19
  ...
  object QBrowse: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      000000060000004953504F5354010000000000}
    Cursor = crSQLWait
    ReadOnly = True
  ...
  object QMaster: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db3.bukti_mkl a'
    ...
    SequenceField.Sequence = 'IPISMA_DB3.IBUKTI_MKL'
    QBEDefinition.QBEFieldDefs = {
  ...
  object QDetail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from ipisma_db3.bukti_detail_mkl a'
      'where ibukti = :ibukti')
  ...
  object ppReportInput: TppReport
    ...
    object ppTitleBand2: TppTitleBand
      ...
      object JUDULPRINT: TppLabel
        UserName = 'Label203'
        HyperlinkColor = clBlue
        OnGetText = JUDULPRINTGetText
        Border.BorderPositions = []
        Border.Color = clBlack
        Border.Style = psSolid
        Border.Visible = False
  ...
  object QTotal: TOracleDataSet
    SQL.Strings = (
        ...
        'sum(qty2) as kg from ipisma_db3.bukti_detail_mkl a'
      'where ibukti = :ibukti')
