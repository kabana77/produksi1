...
type
  TKoreksiKeluarJDFrm = class(TForm)
    ...
    QDetail2QTY9: TFloatField;
    QDetail2QTY10: TFloatField;
    QBrowse2QTY9: TFloatField;
    QBrowse2QTY10: TFloatField;
...
var
  KoreksiKeluarJDFrm: TKoreksiKeluarJDFrm;
...
{$R *.dfm}
procedure TKoreksiKeluarJDFrm.totalSatuan;
begin
  QTotalMeter.Close;
  QTotalPotong.Close;
...
//  if BPBFrm=Nil then
  begin
    KoreksiKeluarJDFrm:=TKoreksiKeluarJDFrm.Create(Application);
    KoreksiKeluarJDFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       KoreksiKeluarJDFrm.QMaster2.ReadOnly:=True;
       KoreksiKeluarJDFrm.QDetail2.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    KoreksiKeluarJDFrm.Caption:=UpperCase(pjudul);
    KoreksiKeluarJDFrm.vkode:=pkode;
    KoreksiKeluarJDFrm.vjns_lokasi:=pjns_lokasi;
    KoreksiKeluarJDFrm.vjns_brg:=pjns_brg;
    KoreksiKeluarJDFrm.QTransaksi.Open;

    KoreksiKeluarJDFrm.Caption:=UpperCase(pjudul);
//    KoreksiKeluarJDFrm.PanelHeader.Caption:=KoreksiKeluarJDFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+KoreksiKeluarJDFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    KoreksiKeluarJDFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    KoreksiKeluarJDFrm.wwDBGrid1.IniAttributes.SectionName:=KoreksiKeluarJDFrm.Caption+'1';
    KoreksiKeluarJDFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    KoreksiKeluarJDFrm.wwDBGrid1.LoadFromIniFile;
    KoreksiKeluarJDFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    KoreksiKeluarJDFrm.wwDBGrid2.IniAttributes.SectionName:=KoreksiKeluarJDFrm.Caption+'2';
    KoreksiKeluarJDFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    KoreksiKeluarJDFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,KoreksiKeluarJDFrm.Caption+'1',KoreksiKeluarJDFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,KoreksiKeluarJDFrm.Caption+'2',KoreksiKeluarJDFrm.wwDBGrid2);
    KoreksiKeluarJDFrm.wwDBSpinLine1.Value:=KoreksiKeluarJDFrm.wwDBGrid1.RowHeightPercent;
    KoreksiKeluarJDFrm.wwDBSpinLine2.Value:=KoreksiKeluarJDFrm.wwDBGrid2.RowHeightPercent;

  end;

  KoreksiKeluarJDFrm.Show;
end;

procedure TKoreksiKeluarJDFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'1',wwDBGrid1);
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   KoreksiKeluarJDFrm:=Nil;
end;

procedure TKoreksiKeluarJDFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TKoreksiKeluarJDFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TKoreksiKeluarJDFrm.BtnOkClick(Sender: TObject);
begin
...
procedure TKoreksiKeluarJDFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKoreksiKeluarJDFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse2.RecNo)+' dari '+FormatFloat('#,#',QBrowse2.RecordCount)+' Records';
end;

procedure TKoreksiKeluarJDFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TKoreksiKeluarJDFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TKoreksiKeluarJDFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TKoreksiKeluarJDFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TKoreksiKeluarJDFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TKoreksiKeluarJDFrm.BtnOk2Click(Sender: TObject);
begin
{  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TKoreksiKeluarJDFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=0;
end;

procedure TKoreksiKeluarJDFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TKoreksiKeluarJDFrm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TKoreksiKeluarJDFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TKoreksiKeluarJDFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TKoreksiKeluarJDFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TKoreksiKeluarJDFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TKoreksiKeluarJDFrm.TabSheet1Show(Sender: TObject);
begin
  QMaster2.Close;
...
procedure TKoreksiKeluarJDFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TKoreksiKeluarJDFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
  ppNo2.AsInteger:=ppNo2.AsInteger+1;
end;

procedure TKoreksiKeluarJDFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure TKoreksiKeluarJDFrm.BtnPrintInputClick(Sender: TObject);
begin
  ppReportInput.Print;
end;

procedure TKoreksiKeluarJDFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiKeluarJDFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TKoreksiKeluarJDFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TKoreksiKeluarJDFrm.Label5Click(Sender: TObject);
begin
...
procedure TKoreksiKeluarJDFrm.LookKonstruksiEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TKoreksiKeluarJDFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TKoreksiKeluarJDFrm.QMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TKoreksiKeluarJDFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TKoreksiKeluarJDFrm.ppPageStyle1BeforePrint(Sender: TObject);
begin
  ppNo2.AsInteger:=0;
end;

procedure TKoreksiKeluarJDFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TKoreksiKeluarJDFrm.FormCloseQuery(Sender: TObject;
...
procedure TKoreksiKeluarJDFrm.QMasterAfterPost(DataSet: TDataSet);
begin
{  PageControl1.Pages[1].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
  PageControl1.Pages[2].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');}
end;

procedure TKoreksiKeluarJDFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TKoreksiKeluarJDFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TKoreksiKeluarJDFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
{    QItem.SetVariable('pkd_lokasi',vjns_lokasi);
    QItem.SetVariable('psysdate',Trunc(QMasterTGL.AsDateTime));}
end;

procedure TKoreksiKeluarJDFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
{  if modified then
  begin
...
procedure TKoreksiKeluarJDFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TKoreksiKeluarJDFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiKeluarJDFrm.QDetailCalcFields(DataSet: TDataSet);
begin
{  QDetailSELISIH.AsFloat:=QDetailQTY1.AsFloat-
    QDetailQTY2.AsFloat; }
end;

procedure TKoreksiKeluarJDFrm.TabSheet3Show(Sender: TObject);
begin
...
procedure TKoreksiKeluarJDFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
{  QTotal.Close;
...
procedure TKoreksiKeluarJDFrm.LookKonstruksiCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TKoreksiKeluarJDFrm.LookWarnaaCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TKoreksiKeluarJDFrm.LookWarnaaEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TKoreksiKeluarJDFrm.QKonstruksiBeforeOpen(DataSet: TDataSet);
begin
  if wwDBDateTimePicker1.Date >= StrToDate('01/01/2017') then
    begin
      QKonstruksi.Close;
      QKonstruksi.SQL.Text:= 'select * from ipisma_db3.vlook_koreksi_keluar_jd';
      QKonstruksi.Open;
    end
  else
    begin
...
procedure TKoreksiKeluarJDFrm.LookOrderEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;
