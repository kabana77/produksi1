...
type
  TKoreksiMasukJDFrm = class(TForm)
    ...
    ppLabel41: TppLabel;
    ppLabel42: TppLabel;
    QBrowse2QTY7: TFloatField;
    QBrowse2QTY8: TFloatField;
    QDetail2QTY7: TFloatField;
    QDetail2QTY8: TFloatField;
    ...
    QNo_Order: TOracleDataSet;
    LookOrder: TwwDBLookupComboDlg;
    QNo_OrderNO_ORDER: TStringField;
    ppLabel25: TppLabel;
    ppLabel38: TppLabel;
...
var
  KoreksiMasukJDFrm: TKoreksiMasukJDFrm;

procedure ShowForm(pNamaMenu:String; pkode : String; pjudul : string; pjns_brg : String; pjns_lokasi : String);

implementation

uses DM, Pembelian, OrderJetDyeing, HasilJetDyeing, KeluarJetDyeing;

{$R *.dfm}
procedure TKoreksiMasukJDFrm.totalSatuan;
begin
  QTotalMeter.Close;
  QTotalPotong.Close;
...
//  if BPBFrm=Nil then
  begin
    KoreksiMasukJDFrm:=TKoreksiMasukJDFrm.Create(Application);
    KoreksiMasukJDFrm.PageControl1.ActivePageIndex:=1;
    if not DMFrm.cHakInput then
    begin
       KoreksiMasukJDFrm.QMaster2.ReadOnly:=True;
       KoreksiMasukJDFrm.QDetail2.ReadOnly:=True;
    end;
    mychar:=pjudul;
    Delete(mychar,Pos('&',mychar),1);
    pjudul:=mychar;
    KoreksiMasukJDFrm.Caption:=UpperCase(pjudul);
    KoreksiMasukJDFrm.vkode:=pkode;
    KoreksiMasukJDFrm.vjns_lokasi:=pjns_lokasi;
    KoreksiMasukJDFrm.vjns_brg:=pjns_brg;
    KoreksiMasukJDFrm.QTransaksi.Open;

    KoreksiMasukJDFrm.Caption:=UpperCase(pjudul);
//    KoreksiMasukJDFrm.PanelHeader.Caption:=KoreksiMasukJDFrm.QTransaksiKD_TRANSAKSI.AsString+'. '+KoreksiMasukJDFrm.QTransaksiNAMA_TRANSAKSI.AsString;
    KoreksiMasukJDFrm.wwDBGrid1.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    KoreksiMasukJDFrm.wwDBGrid1.IniAttributes.SectionName:=KoreksiMasukJDFrm.Caption+'1';
    KoreksiMasukJDFrm.wwDBGrid1.IniAttributes.Enabled:=True;
    KoreksiMasukJDFrm.wwDBGrid1.LoadFromIniFile;
    KoreksiMasukJDFrm.wwDBGrid2.IniAttributes.FileName:=DMFrm.sAppPath+Application.Title+'2.ini';
    KoreksiMasukJDFrm.wwDBGrid2.IniAttributes.SectionName:=KoreksiMasukJDFrm.Caption+'2';
    KoreksiMasukJDFrm.wwDBGrid2.IniAttributes.Enabled:=True;
    KoreksiMasukJDFrm.wwDBGrid2.LoadFromIniFile;
    DMFrm.ProcReadIni(Application.Title,KoreksiMasukJDFrm.Caption+'1',KoreksiMasukJDFrm.wwDBGrid1);
    DMFrm.ProcReadIni(Application.Title,KoreksiMasukJDFrm.Caption+'2',KoreksiMasukJDFrm.wwDBGrid2);
    KoreksiMasukJDFrm.wwDBSpinLine1.Value:=KoreksiMasukJDFrm.wwDBGrid1.RowHeightPercent;
    KoreksiMasukJDFrm.wwDBSpinLine2.Value:=KoreksiMasukJDFrm.wwDBGrid2.RowHeightPercent;

  end;

  KoreksiMasukJDFrm.Show;
end;

procedure TKoreksiMasukJDFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   DMFrm.ProcWtiteIni(Application.Title,Caption+'1',wwDBGrid1);
   DMFrm.ProcWtiteIni(Application.Title,Caption+'2',wwDBGrid2);
   Action:=caFree;
   KoreksiMasukJDFrm:=Nil;
end;

procedure TKoreksiMasukJDFrm.FormCreate(Sender: TObject);
begin
//barcode
...
procedure TKoreksiMasukJDFrm.BtnExportClick(Sender: TObject);
begin
...
procedure TKoreksiMasukJDFrm.BtnOkClick(Sender: TObject);
begin
...
procedure TKoreksiMasukJDFrm.wwDBGrid2TitleButtonClick(Sender: TObject;
  AFieldName: String);
begin
...
procedure TKoreksiMasukJDFrm.QBrowseAfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse2.RecNo)+' dari '+FormatFloat('#,#',QBrowse2.RecordCount)+' Records';
end;

procedure TKoreksiMasukJDFrm.BtnClose1Click(Sender: TObject);
begin
  Close;
end;

procedure TKoreksiMasukJDFrm.BtnClose2Click(Sender: TObject);
begin
  Close;
end;

procedure TKoreksiMasukJDFrm.vTglAwalChange(Sender: TObject);
begin
  vTglAkhir.DateTime:=EndOfTheMonth(vTglAwal.Date);
end;

procedure TKoreksiMasukJDFrm.wwDBSpinLine2Change(Sender: TObject);
begin
    wwDBGrid2.RowHeightPercent:=Round(wwDBSpinLine2.Value);
end;

procedure TKoreksiMasukJDFrm.BtnFindClick(Sender: TObject);
begin
...
procedure TKoreksiMasukJDFrm.BtnOk2Click(Sender: TObject);
begin
{  if QBrowse.QBEMode then
  begin
    QBrowse.ExecuteQBE;
...
procedure TKoreksiMasukJDFrm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=0;
end;

procedure TKoreksiMasukJDFrm.BtnPrintBrowseClick(Sender: TObject);
begin
  if vTglAwal.Date>vTglAkhir.DateTime then
    ShowMessage('Tgl. Akhir harus lebih besar dari Tgl. Awal !')
    else
...
procedure TKoreksiMasukJDFrm.Button1Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TKoreksiMasukJDFrm.BtnDesign2Click(Sender: TObject);
begin
  ppDesigner1.ShowModal;
end;

procedure TKoreksiMasukJDFrm.ppTitleBand1BeforePrint(Sender: TObject);
begin
...
procedure TKoreksiMasukJDFrm.wwDBSpinLine1Change(Sender: TObject);
begin
    wwDBGrid1.RowHeightPercent:=Round(wwDBSpinLine1.Value);
end;

procedure TKoreksiMasukJDFrm.EditCariKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if key=13 then
  begin
...
procedure TKoreksiMasukJDFrm.TabSheet1Show(Sender: TObject);
begin
  QMaster2.Close;
...
procedure TKoreksiMasukJDFrm.TabSheet1Exit(Sender: TObject);
begin
  EditCari.Text:='';
end;

procedure TKoreksiMasukJDFrm.ppDetailBand2BeforePrint(Sender: TObject);
begin
  ppNo2.AsInteger:=ppNo2.AsInteger+1;
end;

procedure TKoreksiMasukJDFrm.ppFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure TKoreksiMasukJDFrm.BtnPrintInputClick(Sender: TObject);
begin
  ppReportInput.Print;
end;

procedure TKoreksiMasukJDFrm.QMasterBeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiMasukJDFrm.wwDBGrid1Enter(Sender: TObject);
begin
...
procedure TKoreksiMasukJDFrm.wwDBGrid2DblClick(Sender: TObject);
begin
  TabSheet1.Show;
end;

procedure TKoreksiMasukJDFrm.Label5Click(Sender: TObject);
begin
...
procedure TKoreksiMasukJDFrm.LookKonstruksiEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TKoreksiMasukJDFrm.QMasterBeforeDelete(DataSet: TDataSet);
begin
...
procedure TKoreksiMasukJDFrm.QMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TKoreksiMasukJDFrm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TKoreksiMasukJDFrm.ppPageStyle1BeforePrint(Sender: TObject);
begin
  ppNo2.AsInteger:=0;
end;

procedure TKoreksiMasukJDFrm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TKoreksiMasukJDFrm.FormCloseQuery(Sender: TObject;
...
procedure TKoreksiMasukJDFrm.QMasterAfterPost(DataSet: TDataSet);
begin
{  PageControl1.Pages[1].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
  PageControl1.Pages[2].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');}
end;

procedure TKoreksiMasukJDFrm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TKoreksiMasukJDFrm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TKoreksiMasukJDFrm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
{    QItem.SetVariable('pkd_lokasi',vjns_lokasi);
    QItem.SetVariable('psysdate',Trunc(QMasterTGL.AsDateTime));}
end;

procedure TKoreksiMasukJDFrm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
{  if modified then
  begin
...
procedure TKoreksiMasukJDFrm.QDetailNewRecord(DataSet: TDataSet);
begin
...
procedure TKoreksiMasukJDFrm.QDetailBeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiMasukJDFrm.QDetailCalcFields(DataSet: TDataSet);
begin
{  QDetailSELISIH.AsFloat:=QDetailQTY1.AsFloat-
    QDetailQTY2.AsFloat; }
end;

procedure TKoreksiMasukJDFrm.TabSheet3Show(Sender: TObject);
begin
...
procedure TKoreksiMasukJDFrm.wwDBGrid1UpdateFooter(Sender: TObject);
begin
{  QTotal.Close;
...
procedure TKoreksiMasukJDFrm.QMaster2BeforeInsert(DataSet: TDataSet);
begin
  if DataSet['ISPOST']='0' then
  begin
    if MessageDlg('Data belum di-POSTING, batalkan ?', mtWarning, [mbYes, mbNo],0)=mrYes then
...
procedure TKoreksiMasukJDFrm.QMaster2BeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiMasukJDFrm.QMaster2NewRecord(DataSet: TDataSet);
begin
...
procedure TKoreksiMasukJDFrm.QDetail2BeforeDelete(DataSet: TDataSet);
begin
  if QMaster2ISPOST.AsString='1' then
  begin
     ShowMessage('Maaf, sudah di-POST !, tidak bisa diubah...');
...
procedure TKoreksiMasukJDFrm.QDetail2BeforeEdit(DataSet: TDataSet);
begin
  if QMaster2ISPOST.AsString='1' then
  begin
     ShowMessage('Maaf, sudah di-POST !, tidak bisa diubah...');
...
procedure TKoreksiMasukJDFrm.QDetail2BeforeInsert(DataSet: TDataSet);
begin
  if QMaster2ISPOST.AsString='1' then
  begin
     ShowMessage('Maaf, sudah di-POST !, tidak bisa diubah...');
...
procedure TKoreksiMasukJDFrm.QDetail2BeforePost(DataSet: TDataSet);
begin
...
procedure TKoreksiMasukJDFrm.QDetail2CalcFields(DataSet: TDataSet);
begin
{  QDetail2SELISIH.AsFloat:=QDetail2QTY1.AsFloat-
    QDetail2QTY2.AsFloat; }
end;

procedure TKoreksiMasukJDFrm.QDetail2NewRecord(DataSet: TDataSet);
begin
  QDetail2QTY7.AsFloat:=0;
  QDetail2QTY8.AsFloat:=0;
  QDetail2IBUKTI.AsInteger:=QMaster2IBUKTI.AsInteger;
end;

procedure TKoreksiMasukJDFrm.QBrowse2AfterScroll(DataSet: TDataSet);
begin
  LabelBanner.Caption:='Record ke '+IntToStr(QBrowse2.RecNo)+' dari '+FormatFloat('#,#',QBrowse2.RecordCount)+' Records';
end;

procedure TKoreksiMasukJDFrm.LookWrnaCloseUp(Sender: TObject;
...
procedure TKoreksiMasukJDFrm.wwDBGrid2UpdateFooter(Sender: TObject);
begin
{
  QTotal.Close;
  QTotal.SetVariable('pawal',vTglAwal.Date);
...
procedure TKoreksiMasukJDFrm.LookKonstruksiCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TKoreksiMasukJDFrm.LookWarnaaCloseUp(Sender: TObject;
  LookupTable, FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TKoreksiMasukJDFrm.LookWarnaaEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TKoreksiMasukJDFrm.QKonstruksiBeforeOpen(DataSet: TDataSet);
begin
//  QKonstruksiWARNA.AsString:= DMFrm.QWarnaWARNA.AsString;
end;

procedure TKoreksiMasukJDFrm.LookOrderEnter(Sender: TObject);
begin
  (sender as TwwDBLookupComboDlg).LookupTable.Open;
end;

procedure TKoreksiMasukJDFrm.LookWarnaCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  QDetail2WARNA.AsString:=DMFrm.QWarnaWARNA.AsString;
end;
