object OrderCelupFrm: TOrderCelupFrm
  Left = 301
  Top = 74
  Width = 1010
  Height = 659
        ...
        object PanelDetail: TPanel
          ...
          object wwDBGrid1: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'QTY1'#9'10'#9'Kg'#9'T'#9'STOK GUDANG'
              'QTY6'#9'7'#9'Pcs'#9'T'#9'STOK GUDANG'
              'QTY3'#9'8'#9'Kg'#9'F'#9'ORDER'
              'QTY8'#9'6'#9'Pcs'#9'F'#9'ORDER')
  ...
  object QBrowse: TOracleDataSet
    SQL.Strings = (
      'select * from ipisma_db3.vordercelupfrm')
    QBEDefinition.QBEFieldDefs = {
      040000001D000000070000004E4F5F4E4F54410100000000000700000054414E
      ...
      
      000000020000004B470100000000000400000042414C4C010000000000}
    Cursor = crSQLWait
    ReadOnly = True
  ...
  object QDetail: TOracleDataSet
    ...
    SequenceField.Sequence = 'IPISMA_DB3.IBUKTI_DETAIL4'
    QBEDefinition.QBEFieldDefs = {
  ...
  object QItem: TOracleDataSet
    SQL.Strings = (
      ...
      'a.kd_jns_item ='#39'30'#39' and b.tgl<=sysdate'
        ...
        'group by a.kd_item, a.nama_item, d.warna, b.kd_warna, a.kd_satua' +
        'n, a.rasio) :myparam')
    Variables.Data = {
  ...
  object OD_Detail: TOracleDataSet
    SQL.Strings = (
      'select a.*, a.rowid from bukti_detail4 a'
