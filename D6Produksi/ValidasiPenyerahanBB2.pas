...
type
  TValidasiPenyerahanBB2Frm = class(TForm)
    PanelLeft: TPanel;
    PanelRight: TPanel;
    PanelMain: TPanel;
    PanelHeader: TPanel;
...
var
  ValidasiPenyerahanBB2Frm: TValidasiPenyerahanBB2Frm;
...
//  if BPBFrm=Nil then
  begin
    ValidasiPenyerahanBB2Frm:=TValidasiPenyerahanBB2Frm.Create(Application);
...
procedure TValidasiPenyerahanBB2Frm.QMasterNewRecord(DataSet: TDataSet);
begin
...
procedure TValidasiPenyerahanBB2Frm.QTransaksiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TValidasiPenyerahanBB2Frm.Label14Click(Sender: TObject);
begin
  if DMFrm.FontDialog1.Execute then
  begin
...
procedure TValidasiPenyerahanBB2Frm.FormCloseQuery(Sender: TObject;
...
procedure TValidasiPenyerahanBB2Frm.QMasterAfterPost(DataSet: TDataSet);
begin
  PageControl1.Pages[1].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
  PageControl1.Pages[2].TabVisible:=QMaster.IsEmpty or (QMasterISPOST.AsString='1');
end;

procedure TValidasiPenyerahanBB2Frm.QMasterBeforeInsert(DataSet: TDataSet);
begin
...
procedure TValidasiPenyerahanBB2Frm.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=ppNo.AsInteger+1;
end;

procedure TValidasiPenyerahanBB2Frm.QLokasiBeforeOpen(DataSet: TDataSet);
begin
...
procedure TValidasiPenyerahanBB2Frm.LookLokasiEnter(Sender: TObject);
begin
  QLokasi.Open;
end;

procedure TValidasiPenyerahanBB2Frm.QItemBeforeQuery(Sender: TOracleDataSet);
begin
  if vjns_brg<>'' then
  begin
...
procedure TValidasiPenyerahanBB2Frm.LookItemCloseUp(Sender: TObject; LookupTable,
  FillTable: TDataSet; modified: Boolean);
begin
  if modified then
  begin
...
procedure TValidasiPenyerahanBB2Frm.QDetailNewRecord(DataSet: TDataSet);
begin
  QDetailIBUKTI.AsInteger:=QMasterIBUKTI.AsInteger;
end;

procedure TValidasiPenyerahanBB2Frm.QDetailBeforePost(DataSet: TDataSet);
begin
