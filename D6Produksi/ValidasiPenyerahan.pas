...
//  if BPBFrm=Nil then
  begin
    ...
    if copy(pjudul,2,2)='31' then ValidasiPenyerahanFrm.vkode:=pkode+'E'+copy(pjudul,4,1)
    else
    if copy(pjudul,2,2)='32' then ValidasiPenyerahanFrm.vkode:=pkode+'F'+copy(pjudul,4,1)
    else
    if copy(pjudul,2,2)='33' then ValidasiPenyerahanFrm.vkode:=pkode+'G'+copy(pjudul,4,1)
    else
    if copy(pjudul,2,2)='34' then ValidasiPenyerahanFrm.vkode:=pkode+'H'+copy(pjudul,4,1)
    else
    if copy(pjudul,2,2)='35' then ValidasiPenyerahanFrm.vkode:=pkode+'I'+copy(pjudul,4,1)
    else
    if copy(pjudul,2,2)='36' then ValidasiPenyerahanFrm.vkode:=pkode+'J'+copy(pjudul,4,1)
    else
    if copy(pjudul,2,2)='37' then ValidasiPenyerahanFrm.vkode:=pkode+'K'+copy(pjudul,4,1)
    else
    if copy(pjudul,2,2)='38' then ValidasiPenyerahanFrm.vkode:=pkode+'L'+copy(pjudul,4,1)
    else
    if copy(pjudul,2,2)='39' then ValidasiPenyerahanFrm.vkode:=pkode+'M'+copy(pjudul,4,1)
    else
