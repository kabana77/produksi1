...
procedure TPindahLokasi2Frm.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  ppNo.AsInteger:=0;
end;
...
procedure TPindahLokasi2Frm.ppDetailBand2BeforePrint(Sender: TObject);
begin
...
procedure TPindahLokasi2Frm.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  DMFrm.QDateTime.Open;
end;

procedure TPindahLokasi2Frm.QRBand6BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  DMFrm.QDateTime.Open;
end;

procedure TPindahLokasi2Frm.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  QRLPeriode1.Caption:=vTglAwal.Text+' s/d '+vTglAkhir.Text;
end;

procedure TPindahLokasi2Frm.wwDBDateTimePicker1Change(Sender: TObject);
begin
  QItem.Refresh;
end;

procedure TPindahLokasi2Frm.wwDBGrid1CalcCellColors(Sender: TObject;
...
procedure TPindahLokasi2Frm.QMasterAfterDelete(DataSet: TDataSet);
begin
  wwDBDateTimePicker1.Enabled:=False;
